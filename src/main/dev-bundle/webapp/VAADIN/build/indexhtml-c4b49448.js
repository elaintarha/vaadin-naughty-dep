(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();window.Vaadin=window.Vaadin||{};window.Vaadin.featureFlags=window.Vaadin.featureFlags||{};window.Vaadin.featureFlags.exampleFeatureFlag=!1;window.Vaadin.featureFlags.collaborationEngineBackend=!1;window.Vaadin.featureFlags.webPush=!1;window.Vaadin.featureFlags.formFillerAddon=!1;const Mn="modulepreload",Vn=function(t,e){return new URL(t,e).href},ei={},g=function(e,o,i){if(!o||o.length===0)return e();const n=document.getElementsByTagName("link");return Promise.all(o.map(s=>{if(s=Vn(s,i),s in ei)return;ei[s]=!0;const r=s.endsWith(".css"),l=r?'[rel="stylesheet"]':"";if(!!i)for(let c=n.length-1;c>=0;c--){const m=n[c];if(m.href===s&&(!r||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${s}"]${l}`))return;const d=document.createElement("link");if(d.rel=r?"stylesheet":Mn,r||(d.as="script",d.crossOrigin=""),d.href=s,document.head.appendChild(d),r)return new Promise((c,m)=>{d.addEventListener("load",c),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${s}`)))})})).then(()=>e()).catch(s=>{const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s})};function bt(t){return t=t||[],Array.isArray(t)?t:[t]}function Q(t){return`[Vaadin.Router] ${t}`}function Dn(t){if(typeof t!="object")return String(t);const e=Object.prototype.toString.call(t).match(/ (.*)\]$/)[1];return e==="Object"||e==="Array"?`${e} ${JSON.stringify(t)}`:e}const wt="module",Et="nomodule",_o=[wt,Et];function ti(t){if(!t.match(/.+\.[m]?js$/))throw new Error(Q(`Unsupported type for bundle "${t}": .js or .mjs expected.`))}function Qi(t){if(!t||!J(t.path))throw new Error(Q('Expected route config to be an object with a "path" string property, or an array of such objects'));const e=t.bundle,o=["component","redirect","bundle"];if(!Ee(t.action)&&!Array.isArray(t.children)&&!Ee(t.children)&&!xt(e)&&!o.some(i=>J(t[i])))throw new Error(Q(`Expected route config "${t.path}" to include either "${o.join('", "')}" or "action" function but none found.`));if(e)if(J(e))ti(e);else if(_o.some(i=>i in e))_o.forEach(i=>i in e&&ti(e[i]));else throw new Error(Q('Expected route bundle to include either "'+Et+'" or "'+wt+'" keys, or both'));t.redirect&&["bundle","component"].forEach(i=>{i in t&&console.warn(Q(`Route config "${t.path}" has both "redirect" and "${i}" properties, and "redirect" will always override the latter. Did you mean to only use "${i}"?`))})}function oi(t){bt(t).forEach(e=>Qi(e))}function ii(t,e){let o=document.head.querySelector('script[src="'+t+'"][async]');return o||(o=document.createElement("script"),o.setAttribute("src",t),e===wt?o.setAttribute("type",wt):e===Et&&o.setAttribute(Et,""),o.async=!0),new Promise((i,n)=>{o.onreadystatechange=o.onload=s=>{o.__dynamicImportLoaded=!0,i(s)},o.onerror=s=>{o.parentNode&&o.parentNode.removeChild(o),n(s)},o.parentNode===null?document.head.appendChild(o):o.__dynamicImportLoaded&&i()})}function zn(t){return J(t)?ii(t):Promise.race(_o.filter(e=>e in t).map(e=>ii(t[e],e)))}function qe(t,e){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${t}`,{cancelable:t==="go",detail:e}))}function xt(t){return typeof t=="object"&&!!t}function Ee(t){return typeof t=="function"}function J(t){return typeof t=="string"}function Zi(t){const e=new Error(Q(`Page not found (${t.pathname})`));return e.context=t,e.code=404,e}const Pe=new class{};function Un(t){const e=t.port,o=t.protocol,s=o==="http:"&&e==="80"||o==="https:"&&e==="443"?t.hostname:t.host;return`${o}//${s}`}function ni(t){if(t.defaultPrevented||t.button!==0||t.shiftKey||t.ctrlKey||t.altKey||t.metaKey)return;let e=t.target;const o=t.composedPath?t.composedPath():t.path||[];for(let l=0;l<o.length;l++){const a=o[l];if(a.nodeName&&a.nodeName.toLowerCase()==="a"){e=a;break}}for(;e&&e.nodeName.toLowerCase()!=="a";)e=e.parentNode;if(!e||e.nodeName.toLowerCase()!=="a"||e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||e.hasAttribute("router-ignore")||e.pathname===window.location.pathname&&e.hash!==""||(e.origin||Un(e))!==window.location.origin)return;const{pathname:n,search:s,hash:r}=e;qe("go",{pathname:n,search:s,hash:r})&&(t.preventDefault(),t&&t.type==="click"&&window.scrollTo(0,0))}const jn={activate(){window.document.addEventListener("click",ni)},inactivate(){window.document.removeEventListener("click",ni)}},Fn=/Trident/.test(navigator.userAgent);Fn&&!Ee(window.PopStateEvent)&&(window.PopStateEvent=function(t,e){e=e||{};var o=document.createEvent("Event");return o.initEvent(t,!!e.bubbles,!!e.cancelable),o.state=e.state||null,o},window.PopStateEvent.prototype=window.Event.prototype);function si(t){if(t.state==="vaadin-router-ignore")return;const{pathname:e,search:o,hash:i}=window.location;qe("go",{pathname:e,search:o,hash:i})}const Bn={activate(){window.addEventListener("popstate",si)},inactivate(){window.removeEventListener("popstate",si)}};var Fe=rn,Hn=Io,qn=Yn,Wn=on,Gn=sn,en="/",tn="./",Kn=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function Io(t,e){for(var o=[],i=0,n=0,s="",r=e&&e.delimiter||en,l=e&&e.delimiters||tn,a=!1,d;(d=Kn.exec(t))!==null;){var c=d[0],m=d[1],h=d.index;if(s+=t.slice(n,h),n=h+c.length,m){s+=m[1],a=!0;continue}var y="",ce=t[n],he=d[2],ne=d[3],zt=d[4],H=d[5];if(!a&&s.length){var ee=s.length-1;l.indexOf(s[ee])>-1&&(y=s[ee],s=s.slice(0,ee))}s&&(o.push(s),s="",a=!1);var ke=y!==""&&ce!==void 0&&ce!==y,Te=H==="+"||H==="*",Ut=H==="?"||H==="*",se=y||r,nt=ne||zt;o.push({name:he||i++,prefix:y,delimiter:se,optional:Ut,repeat:Te,partial:ke,pattern:nt?Jn(nt):"[^"+ue(se)+"]+?"})}return(s||n<t.length)&&o.push(s+t.substr(n)),o}function Yn(t,e){return on(Io(t,e))}function on(t){for(var e=new Array(t.length),o=0;o<t.length;o++)typeof t[o]=="object"&&(e[o]=new RegExp("^(?:"+t[o].pattern+")$"));return function(i,n){for(var s="",r=n&&n.encode||encodeURIComponent,l=0;l<t.length;l++){var a=t[l];if(typeof a=="string"){s+=a;continue}var d=i?i[a.name]:void 0,c;if(Array.isArray(d)){if(!a.repeat)throw new TypeError('Expected "'+a.name+'" to not repeat, but got array');if(d.length===0){if(a.optional)continue;throw new TypeError('Expected "'+a.name+'" to not be empty')}for(var m=0;m<d.length;m++){if(c=r(d[m],a),!e[l].test(c))throw new TypeError('Expected all "'+a.name+'" to match "'+a.pattern+'"');s+=(m===0?a.prefix:a.delimiter)+c}continue}if(typeof d=="string"||typeof d=="number"||typeof d=="boolean"){if(c=r(String(d),a),!e[l].test(c))throw new TypeError('Expected "'+a.name+'" to match "'+a.pattern+'", but got "'+c+'"');s+=a.prefix+c;continue}if(a.optional){a.partial&&(s+=a.prefix);continue}throw new TypeError('Expected "'+a.name+'" to be '+(a.repeat?"an array":"a string"))}return s}}function ue(t){return t.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function Jn(t){return t.replace(/([=!:$/()])/g,"\\$1")}function nn(t){return t&&t.sensitive?"":"i"}function Xn(t,e){if(!e)return t;var o=t.source.match(/\((?!\?)/g);if(o)for(var i=0;i<o.length;i++)e.push({name:i,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return t}function Qn(t,e,o){for(var i=[],n=0;n<t.length;n++)i.push(rn(t[n],e,o).source);return new RegExp("(?:"+i.join("|")+")",nn(o))}function Zn(t,e,o){return sn(Io(t,o),e,o)}function sn(t,e,o){o=o||{};for(var i=o.strict,n=o.start!==!1,s=o.end!==!1,r=ue(o.delimiter||en),l=o.delimiters||tn,a=[].concat(o.endsWith||[]).map(ue).concat("$").join("|"),d=n?"^":"",c=t.length===0,m=0;m<t.length;m++){var h=t[m];if(typeof h=="string")d+=ue(h),c=m===t.length-1&&l.indexOf(h[h.length-1])>-1;else{var y=h.repeat?"(?:"+h.pattern+")(?:"+ue(h.delimiter)+"(?:"+h.pattern+"))*":h.pattern;e&&e.push(h),h.optional?h.partial?d+=ue(h.prefix)+"("+y+")?":d+="(?:"+ue(h.prefix)+"("+y+"))?":d+=ue(h.prefix)+"("+y+")"}}return s?(i||(d+="(?:"+r+")?"),d+=a==="$"?"$":"(?="+a+")"):(i||(d+="(?:"+r+"(?="+a+"))?"),c||(d+="(?="+r+"|"+a+")")),new RegExp(d,nn(o))}function rn(t,e,o){return t instanceof RegExp?Xn(t,e):Array.isArray(t)?Qn(t,e,o):Zn(t,e,o)}Fe.parse=Hn;Fe.compile=qn;Fe.tokensToFunction=Wn;Fe.tokensToRegExp=Gn;const{hasOwnProperty:es}=Object.prototype,bo=new Map;bo.set("|false",{keys:[],pattern:/(?:)/});function ri(t){try{return decodeURIComponent(t)}catch{return t}}function ts(t,e,o,i,n){o=!!o;const s=`${t}|${o}`;let r=bo.get(s);if(!r){const d=[];r={keys:d,pattern:Fe(t,d,{end:o,strict:t===""})},bo.set(s,r)}const l=r.pattern.exec(e);if(!l)return null;const a=Object.assign({},n);for(let d=1;d<l.length;d++){const c=r.keys[d-1],m=c.name,h=l[d];(h!==void 0||!es.call(a,m))&&(c.repeat?a[m]=h?h.split(c.delimiter).map(ri):[]:a[m]=h&&ri(h))}return{path:l[0],keys:(i||[]).concat(r.keys),params:a}}function an(t,e,o,i,n){let s,r,l=0,a=t.path||"";return a.charAt(0)==="/"&&(o&&(a=a.substr(1)),o=!0),{next(d){if(t===d)return{done:!0};const c=t.__children=t.__children||t.children;if(!s&&(s=ts(a,e,!c,i,n),s))return{done:!1,value:{route:t,keys:s.keys,params:s.params,path:s.path}};if(s&&c)for(;l<c.length;){if(!r){const h=c[l];h.parent=t;let y=s.path.length;y>0&&e.charAt(y)==="/"&&(y+=1),r=an(h,e.substr(y),o,s.keys,s.params)}const m=r.next(d);if(!m.done)return{done:!1,value:m.value};r=null,l++}return{done:!0}}}}function os(t){if(Ee(t.route.action))return t.route.action(t)}function is(t,e){let o=e;for(;o;)if(o=o.parent,o===t)return!0;return!1}function ns(t){let e=`Path '${t.pathname}' is not properly resolved due to an error.`;const o=(t.route||{}).path;return o&&(e+=` Resolution had failed on route: '${o}'`),e}function ss(t,e){const{route:o,path:i}=e;if(o&&!o.__synthetic){const n={path:i,route:o};if(!t.chain)t.chain=[];else if(o.parent){let s=t.chain.length;for(;s--&&t.chain[s].route&&t.chain[s].route!==o.parent;)t.chain.pop()}t.chain.push(n)}}class Ge{constructor(e,o={}){if(Object(e)!==e)throw new TypeError("Invalid routes");this.baseUrl=o.baseUrl||"",this.errorHandler=o.errorHandler,this.resolveRoute=o.resolveRoute||os,this.context=Object.assign({resolver:this},o.context),this.root=Array.isArray(e)?{path:"",__children:e,parent:null,__synthetic:!0}:e,this.root.parent=null}getRoutes(){return[...this.root.__children]}setRoutes(e){oi(e);const o=[...bt(e)];this.root.__children=o}addRoutes(e){return oi(e),this.root.__children.push(...bt(e)),this.getRoutes()}removeRoutes(){this.setRoutes([])}resolve(e){const o=Object.assign({},this.context,J(e)?{pathname:e}:e),i=an(this.root,this.__normalizePathname(o.pathname),this.baseUrl),n=this.resolveRoute;let s=null,r=null,l=o;function a(d,c=s.value.route,m){const h=m===null&&s.value.route;return s=r||i.next(h),r=null,!d&&(s.done||!is(c,s.value.route))?(r=s,Promise.resolve(Pe)):s.done?Promise.reject(Zi(o)):(l=Object.assign(l?{chain:l.chain?l.chain.slice(0):[]}:{},o,s.value),ss(l,s.value),Promise.resolve(n(l)).then(y=>y!=null&&y!==Pe?(l.result=y.result||y,l):a(d,c,y)))}return o.next=a,Promise.resolve().then(()=>a(!0,this.root)).catch(d=>{const c=ns(l);if(d?console.warn(c):d=new Error(c),d.context=d.context||l,d instanceof DOMException||(d.code=d.code||500),this.errorHandler)return l.result=this.errorHandler(d),l;throw d})}static __createUrl(e,o){return new URL(e,o)}get __effectiveBaseUrl(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}__normalizePathname(e){if(!this.baseUrl)return e;const o=this.__effectiveBaseUrl,i=this.constructor.__createUrl(e,o).href;if(i.slice(0,o.length)===o)return i.slice(o.length)}}Ge.pathToRegexp=Fe;const{pathToRegexp:ai}=Ge,li=new Map;function ln(t,e,o){const i=e.name||e.component;if(i&&(t.has(i)?t.get(i).push(e):t.set(i,[e])),Array.isArray(o))for(let n=0;n<o.length;n++){const s=o[n];s.parent=e,ln(t,s,s.__children||s.children)}}function di(t,e){const o=t.get(e);if(o&&o.length>1)throw new Error(`Duplicate route with name "${e}". Try seting unique 'name' route properties.`);return o&&o[0]}function ci(t){let e=t.path;return e=Array.isArray(e)?e[0]:e,e!==void 0?e:""}function rs(t,e={}){if(!(t instanceof Ge))throw new TypeError("An instance of Resolver is expected");const o=new Map;return(i,n)=>{let s=di(o,i);if(!s&&(o.clear(),ln(o,t.root,t.root.__children),s=di(o,i),!s))throw new Error(`Route "${i}" not found`);let r=li.get(s.fullPath);if(!r){let a=ci(s),d=s.parent;for(;d;){const y=ci(d);y&&(a=y.replace(/\/$/,"")+"/"+a.replace(/^\//,"")),d=d.parent}const c=ai.parse(a),m=ai.tokensToFunction(c),h=Object.create(null);for(let y=0;y<c.length;y++)J(c[y])||(h[c[y].name]=!0);r={toPath:m,keys:h},li.set(a,r),s.fullPath=a}let l=r.toPath(n,e)||"/";if(e.stringifyQueryParams&&n){const a={},d=Object.keys(n);for(let m=0;m<d.length;m++){const h=d[m];r.keys[h]||(a[h]=n[h])}const c=e.stringifyQueryParams(a);c&&(l+=c.charAt(0)==="?"?c:`?${c}`)}return l}}let hi=[];function as(t){hi.forEach(e=>e.inactivate()),t.forEach(e=>e.activate()),hi=t}const ls=t=>{const e=getComputedStyle(t).getPropertyValue("animation-name");return e&&e!=="none"},ds=(t,e)=>{const o=()=>{t.removeEventListener("animationend",o),e()};t.addEventListener("animationend",o)};function ui(t,e){return t.classList.add(e),new Promise(o=>{if(ls(t)){const i=t.getBoundingClientRect(),n=`height: ${i.bottom-i.top}px; width: ${i.right-i.left}px`;t.setAttribute("style",`position: absolute; ${n}`),ds(t,()=>{t.classList.remove(e),t.removeAttribute("style"),o()})}else t.classList.remove(e),o()})}const cs=256;function Ht(t){return t!=null}function hs(t){const e=Object.assign({},t);return delete e.next,e}function G({pathname:t="",search:e="",hash:o="",chain:i=[],params:n={},redirectFrom:s,resolver:r},l){const a=i.map(d=>d.route);return{baseUrl:r&&r.baseUrl||"",pathname:t,search:e,hash:o,routes:a,route:l||a.length&&a[a.length-1]||null,params:n,redirectFrom:s,getUrl:(d={})=>vt(pe.pathToRegexp.compile(dn(a))(Object.assign({},n,d)),r)}}function pi(t,e){const o=Object.assign({},t.params);return{redirect:{pathname:e,from:t.pathname,params:o}}}function us(t,e){e.location=G(t);const o=t.chain.map(i=>i.route).indexOf(t.route);return t.chain[o].element=e,e}function mt(t,e,o){if(Ee(t))return t.apply(o,e)}function mi(t,e,o){return i=>{if(i&&(i.cancel||i.redirect))return i;if(o)return mt(o[t],e,o)}}function ps(t,e){if(!Array.isArray(t)&&!xt(t))throw new Error(Q(`Incorrect "children" value for the route ${e.path}: expected array or object, but got ${t}`));e.__children=[];const o=bt(t);for(let i=0;i<o.length;i++)Qi(o[i]),e.__children.push(o[i])}function dt(t){if(t&&t.length){const e=t[0].parentNode;for(let o=0;o<t.length;o++)e.removeChild(t[o])}}function vt(t,e){const o=e.__effectiveBaseUrl;return o?e.constructor.__createUrl(t.replace(/^\//,""),o).pathname:t}function dn(t){return t.map(e=>e.path).reduce((e,o)=>o.length?e.replace(/\/$/,"")+"/"+o.replace(/^\//,""):e,"")}class pe extends Ge{constructor(e,o){const i=document.head.querySelector("base"),n=i&&i.getAttribute("href");super([],Object.assign({baseUrl:n&&Ge.__createUrl(n,document.URL).pathname.replace(/[^\/]*$/,"")},o)),this.resolveRoute=r=>this.__resolveRoute(r);const s=pe.NavigationTrigger;pe.setTriggers.apply(pe,Object.keys(s).map(r=>s[r])),this.baseUrl,this.ready,this.ready=Promise.resolve(e),this.location,this.location=G({resolver:this}),this.__lastStartedRenderId=0,this.__navigationEventHandler=this.__onNavigationEvent.bind(this),this.setOutlet(e),this.subscribe(),this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){const o=e.route;let i=Promise.resolve();Ee(o.children)&&(i=i.then(()=>o.children(hs(e))).then(s=>{!Ht(s)&&!Ee(o.children)&&(s=o.children),ps(s,o)}));const n={redirect:s=>pi(e,s),component:s=>{const r=document.createElement(s);return this.__createdByRouter.set(r,!0),r}};return i.then(()=>{if(this.__isLatestRender(e))return mt(o.action,[e,n],o)}).then(s=>{if(Ht(s)&&(s instanceof HTMLElement||s.redirect||s===Pe))return s;if(J(o.redirect))return n.redirect(o.redirect);if(o.bundle)return zn(o.bundle).then(()=>{},()=>{throw new Error(Q(`Bundle not found: ${o.bundle}. Check if the file name is correct`))})}).then(s=>{if(Ht(s))return s;if(J(o.component))return n.component(o.component)})}setOutlet(e){e&&this.__ensureOutlet(e),this.__outlet=e}getOutlet(){return this.__outlet}setRoutes(e,o=!1){return this.__previousContext=void 0,this.__urlForName=void 0,super.setRoutes(e),o||this.__onNavigationEvent(),this.ready}render(e,o){const i=++this.__lastStartedRenderId,n=Object.assign({search:"",hash:""},J(e)?{pathname:e}:e,{__renderId:i});return this.ready=this.resolve(n).then(s=>this.__fullyResolveChain(s)).then(s=>{if(this.__isLatestRender(s)){const r=this.__previousContext;if(s===r)return this.__updateBrowserHistory(r,!0),this.location;if(this.location=G(s),o&&this.__updateBrowserHistory(s,i===1),qe("location-changed",{router:this,location:this.location}),s.__skipAttach)return this.__copyUnchangedElements(s,r),this.__previousContext=s,this.location;this.__addAppearingContent(s,r);const l=this.__animateIfNeeded(s);return this.__runOnAfterEnterCallbacks(s),this.__runOnAfterLeaveCallbacks(s,r),l.then(()=>{if(this.__isLatestRender(s))return this.__removeDisappearingContent(),this.__previousContext=s,this.location})}}).catch(s=>{if(i===this.__lastStartedRenderId)throw o&&this.__updateBrowserHistory(n),dt(this.__outlet&&this.__outlet.children),this.location=G(Object.assign(n,{resolver:this})),qe("error",Object.assign({router:this,error:s},n)),s}),this.ready}__fullyResolveChain(e,o=e){return this.__findComponentContextAfterAllRedirects(o).then(i=>{const s=i!==o?i:e,l=vt(dn(i.chain),i.resolver)===i.pathname,a=(d,c=d.route,m)=>d.next(void 0,c,m).then(h=>h===null||h===Pe?l?d:c.parent!==null?a(d,c.parent,h):h:h);return a(i).then(d=>{if(d===null||d===Pe)throw Zi(s);return d&&d!==Pe&&d!==i?this.__fullyResolveChain(s,d):this.__amendWithOnBeforeCallbacks(i)})})}__findComponentContextAfterAllRedirects(e){const o=e.result;return o instanceof HTMLElement?(us(e,o),Promise.resolve(e)):o.redirect?this.__redirect(o.redirect,e.__redirectCount,e.__renderId).then(i=>this.__findComponentContextAfterAllRedirects(i)):o instanceof Error?Promise.reject(o):Promise.reject(new Error(Q(`Invalid route resolution result for path "${e.pathname}". Expected redirect object or HTML element, but got: "${Dn(o)}". Double check the action return value for the route.`)))}__amendWithOnBeforeCallbacks(e){return this.__runOnBeforeCallbacks(e).then(o=>o===this.__previousContext||o===e?o:this.__fullyResolveChain(o))}__runOnBeforeCallbacks(e){const o=this.__previousContext||{},i=o.chain||[],n=e.chain;let s=Promise.resolve();const r=()=>({cancel:!0}),l=a=>pi(e,a);if(e.__divergedChainIndex=0,e.__skipAttach=!1,i.length){for(let a=0;a<Math.min(i.length,n.length)&&!(i[a].route!==n[a].route||i[a].path!==n[a].path&&i[a].element!==n[a].element||!this.__isReusableElement(i[a].element,n[a].element));a=++e.__divergedChainIndex);if(e.__skipAttach=n.length===i.length&&e.__divergedChainIndex==n.length&&this.__isReusableElement(e.result,o.result),e.__skipAttach){for(let a=n.length-1;a>=0;a--)s=this.__runOnBeforeLeaveCallbacks(s,e,{prevent:r},i[a]);for(let a=0;a<n.length;a++)s=this.__runOnBeforeEnterCallbacks(s,e,{prevent:r,redirect:l},n[a]),i[a].element.location=G(e,i[a].route)}else for(let a=i.length-1;a>=e.__divergedChainIndex;a--)s=this.__runOnBeforeLeaveCallbacks(s,e,{prevent:r},i[a])}if(!e.__skipAttach)for(let a=0;a<n.length;a++)a<e.__divergedChainIndex?a<i.length&&i[a].element&&(i[a].element.location=G(e,i[a].route)):(s=this.__runOnBeforeEnterCallbacks(s,e,{prevent:r,redirect:l},n[a]),n[a].element&&(n[a].element.location=G(e,n[a].route)));return s.then(a=>{if(a){if(a.cancel)return this.__previousContext.__renderId=e.__renderId,this.__previousContext;if(a.redirect)return this.__redirect(a.redirect,e.__redirectCount,e.__renderId)}return e})}__runOnBeforeLeaveCallbacks(e,o,i,n){const s=G(o);return e.then(r=>{if(this.__isLatestRender(o))return mi("onBeforeLeave",[s,i,this],n.element)(r)}).then(r=>{if(!(r||{}).redirect)return r})}__runOnBeforeEnterCallbacks(e,o,i,n){const s=G(o,n.route);return e.then(r=>{if(this.__isLatestRender(o))return mi("onBeforeEnter",[s,i,this],n.element)(r)})}__isReusableElement(e,o){return e&&o?this.__createdByRouter.get(e)&&this.__createdByRouter.get(o)?e.localName===o.localName:e===o:!1}__isLatestRender(e){return e.__renderId===this.__lastStartedRenderId}__redirect(e,o,i){if(o>cs)throw new Error(Q(`Too many redirects when rendering ${e.from}`));return this.resolve({pathname:this.urlForPath(e.pathname,e.params),redirectFrom:e.from,__redirectCount:(o||0)+1,__renderId:i})}__ensureOutlet(e=this.__outlet){if(!(e instanceof Node))throw new TypeError(Q(`Expected router outlet to be a valid DOM Node (but got ${e})`))}__updateBrowserHistory({pathname:e,search:o="",hash:i=""},n){if(window.location.pathname!==e||window.location.search!==o||window.location.hash!==i){const s=n?"replaceState":"pushState";window.history[s](null,document.title,e+o+i),window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}__copyUnchangedElements(e,o){let i=this.__outlet;for(let n=0;n<e.__divergedChainIndex;n++){const s=o&&o.chain[n].element;if(s)if(s.parentNode===i)e.chain[n].element=s,i=s;else break}return i}__addAppearingContent(e,o){this.__ensureOutlet(),this.__removeAppearingContent();const i=this.__copyUnchangedElements(e,o);this.__appearingContent=[],this.__disappearingContent=Array.from(i.children).filter(s=>this.__addedByRouter.get(s)&&s!==e.result);let n=i;for(let s=e.__divergedChainIndex;s<e.chain.length;s++){const r=e.chain[s].element;r&&(n.appendChild(r),this.__addedByRouter.set(r,!0),n===i&&this.__appearingContent.push(r),n=r)}}__removeDisappearingContent(){this.__disappearingContent&&dt(this.__disappearingContent),this.__disappearingContent=null,this.__appearingContent=null}__removeAppearingContent(){this.__disappearingContent&&this.__appearingContent&&(dt(this.__appearingContent),this.__disappearingContent=null,this.__appearingContent=null)}__runOnAfterLeaveCallbacks(e,o){if(o)for(let i=o.chain.length-1;i>=e.__divergedChainIndex&&this.__isLatestRender(e);i--){const n=o.chain[i].element;if(n)try{const s=G(e);mt(n.onAfterLeave,[s,{},o.resolver],n)}finally{this.__disappearingContent.indexOf(n)>-1&&dt(n.children)}}}__runOnAfterEnterCallbacks(e){for(let o=e.__divergedChainIndex;o<e.chain.length&&this.__isLatestRender(e);o++){const i=e.chain[o].element||{},n=G(e,e.chain[o].route);mt(i.onAfterEnter,[n,{},e.resolver],i)}}__animateIfNeeded(e){const o=(this.__disappearingContent||[])[0],i=(this.__appearingContent||[])[0],n=[],s=e.chain;let r;for(let l=s.length;l>0;l--)if(s[l-1].route.animate){r=s[l-1].route.animate;break}if(o&&i&&r){const l=xt(r)&&r.leave||"leaving",a=xt(r)&&r.enter||"entering";n.push(ui(o,l)),n.push(ui(i,a))}return Promise.all(n).then(()=>e)}subscribe(){window.addEventListener("vaadin-router-go",this.__navigationEventHandler)}unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}__onNavigationEvent(e){const{pathname:o,search:i,hash:n}=e?e.detail:window.location;J(this.__normalizePathname(o))&&(e&&e.preventDefault&&e.preventDefault(),this.render({pathname:o,search:i,hash:n},!0))}static setTriggers(...e){as(e)}urlForName(e,o){return this.__urlForName||(this.__urlForName=rs(this)),vt(this.__urlForName(e,o),this)}urlForPath(e,o){return vt(pe.pathToRegexp.compile(e)(o),this)}static go(e){const{pathname:o,search:i,hash:n}=J(e)?this.__createUrl(e,"http://a"):e;return qe("go",{pathname:o,search:i,hash:n})}}const ms=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,ft=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function vs(){function t(){return!0}return cn(t)}function fs(){try{return gs()?!0:ys()?ft?!_s():!vs():!1}catch{return!1}}function gs(){return localStorage.getItem("vaadin.developmentmode.force")}function ys(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function _s(){return!!(ft&&Object.keys(ft).map(e=>ft[e]).filter(e=>e.productionMode).length>0)}function cn(t,e){if(typeof t!="function")return;const o=ms.exec(t.toString());if(o)try{t=new Function(o[1])}catch(i){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",i)}return t(e)}window.Vaadin=window.Vaadin||{};const vi=function(t,e){if(window.Vaadin.developmentMode)return cn(t,e)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=fs());function bs(){}const ws=function(){if(typeof vi=="function")return vi(bs)};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.4"});ws();pe.NavigationTrigger={POPSTATE:Bn,CLICK:jn};var qt,R;(function(t){t.CONNECTED="connected",t.LOADING="loading",t.RECONNECTING="reconnecting",t.CONNECTION_LOST="connection-lost"})(R||(R={}));class Es{constructor(e){this.stateChangeListeners=new Set,this.loadingCount=0,this.connectionState=e,this.serviceWorkerMessageListener=this.serviceWorkerMessageListener.bind(this),navigator.serviceWorker&&(navigator.serviceWorker.addEventListener("message",this.serviceWorkerMessageListener),navigator.serviceWorker.ready.then(o=>{var i;(i=o==null?void 0:o.active)===null||i===void 0||i.postMessage({method:"Vaadin.ServiceWorker.isConnectionLost",id:"Vaadin.ServiceWorker.isConnectionLost"})}))}addStateChangeListener(e){this.stateChangeListeners.add(e)}removeStateChangeListener(e){this.stateChangeListeners.delete(e)}loadingStarted(){this.state=R.LOADING,this.loadingCount+=1}loadingFinished(){this.decreaseLoadingCount(R.CONNECTED)}loadingFailed(){this.decreaseLoadingCount(R.CONNECTION_LOST)}decreaseLoadingCount(e){this.loadingCount>0&&(this.loadingCount-=1,this.loadingCount===0&&(this.state=e))}get state(){return this.connectionState}set state(e){if(e!==this.connectionState){const o=this.connectionState;this.connectionState=e,this.loadingCount=0;for(const i of this.stateChangeListeners)i(o,this.connectionState)}}get online(){return this.connectionState===R.CONNECTED||this.connectionState===R.LOADING}get offline(){return!this.online}serviceWorkerMessageListener(e){typeof e.data=="object"&&e.data.id==="Vaadin.ServiceWorker.isConnectionLost"&&(e.data.result===!0&&(this.state=R.CONNECTION_LOST),navigator.serviceWorker.removeEventListener("message",this.serviceWorkerMessageListener))}}const xs=t=>!!(t==="localhost"||t==="[::1]"||t.match(/^127\.\d+\.\d+\.\d+$/)),ct=window;if(!(!((qt=ct.Vaadin)===null||qt===void 0)&&qt.connectionState)){let t;xs(window.location.hostname)?t=!0:t=navigator.onLine,ct.Vaadin=ct.Vaadin||{},ct.Vaadin.connectionState=new Es(t?R.CONNECTED:R.CONNECTION_LOST)}function B(t,e,o,i){var n=arguments.length,s=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,o):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(t,e,o,i);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(s=(n<3?r(s):n>3?r(e,o,s):r(e,o))||s);return n>3&&s&&Object.defineProperty(e,o,s),s}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ss=!1,gt=window,Po=gt.ShadowRoot&&(gt.ShadyCSS===void 0||gt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Oo=Symbol(),fi=new WeakMap;class Lo{constructor(e,o,i){if(this._$cssResult$=!0,i!==Oo)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this._strings=o}get styleSheet(){let e=this._styleSheet;const o=this._strings;if(Po&&e===void 0){const i=o!==void 0&&o.length===1;i&&(e=fi.get(o)),e===void 0&&((this._styleSheet=e=new CSSStyleSheet).replaceSync(this.cssText),i&&fi.set(o,e))}return e}toString(){return this.cssText}}const Cs=t=>{if(t._$cssResult$===!0)return t.cssText;if(typeof t=="number")return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},hn=t=>new Lo(typeof t=="string"?t:String(t),void 0,Oo),k=(t,...e)=>{const o=t.length===1?t[0]:e.reduce((i,n,s)=>i+Cs(n)+t[s+1],t[0]);return new Lo(o,t,Oo)},ks=(t,e)=>{Po?t.adoptedStyleSheets=e.map(o=>o instanceof CSSStyleSheet?o:o.styleSheet):e.forEach(o=>{const i=document.createElement("style"),n=gt.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=o.cssText,t.appendChild(i)})},Ts=t=>{let e="";for(const o of t.cssRules)e+=o.cssText;return hn(e)},gi=Po||Ss?t=>t:t=>t instanceof CSSStyleSheet?Ts(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wt,Gt,Kt,un;const oe=window;let pn,me;const yi=oe.trustedTypes,$s=yi?yi.emptyScript:"",yt=oe.reactiveElementPolyfillSupportDevMode;{const t=(Wt=oe.litIssuedWarnings)!==null&&Wt!==void 0?Wt:oe.litIssuedWarnings=new Set;me=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))},me("dev-mode","Lit is in dev mode. Not recommended for production!"),!((Gt=oe.ShadyDOM)===null||Gt===void 0)&&Gt.inUse&&yt===void 0&&me("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded."),pn=e=>({then:(o,i)=>{me("request-update-promise",`The \`requestUpdate\` method should no longer return a Promise but does so on \`${e}\`. Use \`updateComplete\` instead.`),o!==void 0&&o(!1)}})}const Yt=t=>{oe.emitLitDebugLogEvents&&oe.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))},mn=(t,e)=>t,wo={toAttribute(t,e){switch(e){case Boolean:t=t?$s:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t);break}return t},fromAttribute(t,e){let o=t;switch(e){case Boolean:o=t!==null;break;case Number:o=t===null?null:Number(t);break;case Object:case Array:try{o=JSON.parse(t)}catch{o=null}break}return o}},vn=(t,e)=>e!==t&&(e===e||t===t),Jt={attribute:!0,type:String,converter:wo,reflect:!1,hasChanged:vn},Eo="finalized";class ie extends HTMLElement{constructor(){super(),this.__instanceProperties=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}static addInitializer(e){var o;this.finalize(),((o=this._initializers)!==null&&o!==void 0?o:this._initializers=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((o,i)=>{const n=this.__attributeNameForProperty(i,o);n!==void 0&&(this.__attributeToPropertyMap.set(n,i),e.push(n))}),e}static createProperty(e,o=Jt){var i;if(o.state&&(o.attribute=!1),this.finalize(),this.elementProperties.set(e,o),!o.noAccessor&&!this.prototype.hasOwnProperty(e)){const n=typeof e=="symbol"?Symbol():`__${e}`,s=this.getPropertyDescriptor(e,n,o);s!==void 0&&(Object.defineProperty(this.prototype,e,s),this.hasOwnProperty("__reactivePropertyKeys")||(this.__reactivePropertyKeys=new Set((i=this.__reactivePropertyKeys)!==null&&i!==void 0?i:[])),this.__reactivePropertyKeys.add(e))}}static getPropertyDescriptor(e,o,i){return{get(){return this[o]},set(n){const s=this[e];this[o]=n,this.requestUpdate(e,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Jt}static finalize(){if(this.hasOwnProperty(Eo))return!1;this[Eo]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e._initializers!==void 0&&(this._initializers=[...e._initializers]),this.elementProperties=new Map(e.elementProperties),this.__attributeToPropertyMap=new Map,this.hasOwnProperty(mn("properties"))){const o=this.properties,i=[...Object.getOwnPropertyNames(o),...Object.getOwnPropertySymbols(o)];for(const n of i)this.createProperty(n,o[n])}this.elementStyles=this.finalizeStyles(this.styles);{const o=(i,n=!1)=>{this.prototype.hasOwnProperty(i)&&me(n?"renamed-api":"removed-api",`\`${i}\` is implemented on class ${this.name}. It has been ${n?"renamed":"removed"} in this version of LitElement.`)};o("initialize"),o("requestUpdateInternal"),o("_getUpdateComplete",!0)}return!0}static finalizeStyles(e){const o=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const n of i)o.unshift(gi(n))}else e!==void 0&&o.push(gi(e));return o}static __attributeNameForProperty(e,o){const i=o.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}__initialize(){var e;this.__updatePromise=new Promise(o=>this.enableUpdating=o),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),(e=this.constructor._initializers)===null||e===void 0||e.forEach(o=>o(this))}addController(e){var o,i;((o=this.__controllers)!==null&&o!==void 0?o:this.__controllers=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var o;(o=this.__controllers)===null||o===void 0||o.splice(this.__controllers.indexOf(e)>>>0,1)}__saveInstanceProperties(){this.constructor.elementProperties.forEach((e,o)=>{this.hasOwnProperty(o)&&(this.__instanceProperties.set(o,this[o]),delete this[o])})}createRenderRoot(){var e;const o=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return ks(o,this.constructor.elementStyles),o}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this.__controllers)===null||e===void 0||e.forEach(o=>{var i;return(i=o.hostConnected)===null||i===void 0?void 0:i.call(o)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this.__controllers)===null||e===void 0||e.forEach(o=>{var i;return(i=o.hostDisconnected)===null||i===void 0?void 0:i.call(o)})}attributeChangedCallback(e,o,i){this._$attributeToProperty(e,i)}__propertyToAttribute(e,o,i=Jt){var n;const s=this.constructor.__attributeNameForProperty(e,i);if(s!==void 0&&i.reflect===!0){const l=(((n=i.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?i.converter:wo).toAttribute(o,i.type);this.constructor.enabledWarnings.indexOf("migration")>=0&&l===void 0&&me("undefined-attribute-value",`The attribute value for the ${e} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`),this.__reflectingProperty=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this.__reflectingProperty=null}}_$attributeToProperty(e,o){var i;const n=this.constructor,s=n.__attributeToPropertyMap.get(e);if(s!==void 0&&this.__reflectingProperty!==s){const r=n.getPropertyOptions(s),l=typeof r.converter=="function"?{fromAttribute:r.converter}:((i=r.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?r.converter:wo;this.__reflectingProperty=s,this[s]=l.fromAttribute(o,r.type),this.__reflectingProperty=null}}requestUpdate(e,o,i){let n=!0;return e!==void 0&&(i=i||this.constructor.getPropertyOptions(e),(i.hasChanged||vn)(this[e],o)?(this._$changedProperties.has(e)||this._$changedProperties.set(e,o),i.reflect===!0&&this.__reflectingProperty!==e&&(this.__reflectingProperties===void 0&&(this.__reflectingProperties=new Map),this.__reflectingProperties.set(e,i))):n=!1),!this.isUpdatePending&&n&&(this.__updatePromise=this.__enqueueUpdate()),pn(this.localName)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e,o;if(!this.isUpdatePending)return;if(Yt==null||Yt({kind:"update"}),!this.hasUpdated){const s=[];if((e=this.constructor.__reactivePropertyKeys)===null||e===void 0||e.forEach(r=>{var l;this.hasOwnProperty(r)&&!(!((l=this.__instanceProperties)===null||l===void 0)&&l.has(r))&&s.push(r)}),s.length)throw new Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${s.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}this.__instanceProperties&&(this.__instanceProperties.forEach((s,r)=>this[r]=s),this.__instanceProperties=void 0);let i=!1;const n=this._$changedProperties;try{i=this.shouldUpdate(n),i?(this.willUpdate(n),(o=this.__controllers)===null||o===void 0||o.forEach(s=>{var r;return(r=s.hostUpdate)===null||r===void 0?void 0:r.call(s)}),this.update(n)):this.__markUpdated()}catch(s){throw i=!1,this.__markUpdated(),s}i&&this._$didUpdate(n)}willUpdate(e){}_$didUpdate(e){var o;(o=this.__controllers)===null||o===void 0||o.forEach(i=>{var n;return(n=i.hostUpdated)===null||n===void 0?void 0:n.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e),this.isUpdatePending&&this.constructor.enabledWarnings.indexOf("change-in-update")>=0&&me("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(e){return!0}update(e){this.__reflectingProperties!==void 0&&(this.__reflectingProperties.forEach((o,i)=>this.__propertyToAttribute(i,this[i],o)),this.__reflectingProperties=void 0),this.__markUpdated()}updated(e){}firstUpdated(e){}}un=Eo;ie[un]=!0;ie.elementProperties=new Map;ie.elementStyles=[];ie.shadowRootOptions={mode:"open"};yt==null||yt({ReactiveElement:ie});{ie.enabledWarnings=["change-in-update"];const t=function(e){e.hasOwnProperty(mn("enabledWarnings"))||(e.enabledWarnings=e.enabledWarnings.slice())};ie.enableWarning=function(e){t(this),this.enabledWarnings.indexOf(e)<0&&this.enabledWarnings.push(e)},ie.disableWarning=function(e){t(this);const o=this.enabledWarnings.indexOf(e);o>=0&&this.enabledWarnings.splice(o,1)}}((Kt=oe.reactiveElementVersions)!==null&&Kt!==void 0?Kt:oe.reactiveElementVersions=[]).push("1.6.3");oe.reactiveElementVersions.length>1&&me("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Xt,Qt,Zt,eo;const F=window,b=t=>{F.emitLitDebugLogEvents&&F.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))};let As=0,St;(Xt=F.litIssuedWarnings)!==null&&Xt!==void 0||(F.litIssuedWarnings=new Set),St=(t,e)=>{e+=t?` See https://lit.dev/msg/${t} for more information.`:"",F.litIssuedWarnings.has(e)||(console.warn(e),F.litIssuedWarnings.add(e))},St("dev-mode","Lit is in dev mode. Not recommended for production!");const q=!((Qt=F.ShadyDOM)===null||Qt===void 0)&&Qt.inUse&&((Zt=F.ShadyDOM)===null||Zt===void 0?void 0:Zt.noPatch)===!0?F.ShadyDOM.wrap:t=>t,Me=F.trustedTypes,_i=Me?Me.createPolicy("lit-html",{createHTML:t=>t}):void 0,Rs=t=>t,Mt=(t,e,o)=>Rs,Ns=t=>{if(Ce!==Mt)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");Ce=t},Is=()=>{Ce=Mt},xo=(t,e,o)=>Ce(t,e,o),So="$lit$",re=`lit$${String(Math.random()).slice(9)}$`,fn="?"+re,Ps=`<${fn}>`,xe=document,Ke=()=>xe.createComment(""),Ye=t=>t===null||typeof t!="object"&&typeof t!="function",gn=Array.isArray,Os=t=>gn(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",to=`[ 	
\f\r]`,Ls=`[^ 	
\f\r"'\`<>=]`,Ms=`[^\\s"'>=/]`,Be=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,bi=1,oo=2,Vs=3,wi=/-->/g,Ei=/>/g,ge=new RegExp(`>|${to}(?:(${Ms}+)(${to}*=${to}*(?:${Ls}|("|')|))|$)`,"g"),Ds=0,xi=1,zs=2,Si=3,io=/'/g,no=/"/g,yn=/^(?:script|style|textarea|title)$/i,Us=1,Ct=2,Mo=1,kt=2,js=3,Fs=4,Bs=5,Vo=6,Hs=7,_n=t=>(e,...o)=>(e.some(i=>i===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:t,strings:e,values:o}),_=_n(Us),Ie=_n(Ct),Se=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),Ci=new WeakMap,be=xe.createTreeWalker(xe,129,null,!1);let Ce=Mt;function bn(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw")){let o="invalid template strings array";throw o=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(o)}return _i!==void 0?_i.createHTML(e):e}const qs=(t,e)=>{const o=t.length-1,i=[];let n=e===Ct?"<svg>":"",s,r=Be;for(let a=0;a<o;a++){const d=t[a];let c=-1,m,h=0,y;for(;h<d.length&&(r.lastIndex=h,y=r.exec(d),y!==null);)if(h=r.lastIndex,r===Be){if(y[bi]==="!--")r=wi;else if(y[bi]!==void 0)r=Ei;else if(y[oo]!==void 0)yn.test(y[oo])&&(s=new RegExp(`</${y[oo]}`,"g")),r=ge;else if(y[Vs]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else r===ge?y[Ds]===">"?(r=s??Be,c=-1):y[xi]===void 0?c=-2:(c=r.lastIndex-y[zs].length,m=y[xi],r=y[Si]===void 0?ge:y[Si]==='"'?no:io):r===no||r===io?r=ge:r===wi||r===Ei?r=Be:(r=ge,s=void 0);console.assert(c===-1||r===ge||r===io||r===no,"unexpected parse state B");const ce=r===ge&&t[a+1].startsWith("/>")?" ":"";n+=r===Be?d+Ps:c>=0?(i.push(m),d.slice(0,c)+So+d.slice(c)+re+ce):d+re+(c===-2?(i.push(void 0),a):ce)}const l=n+(t[o]||"<?>")+(e===Ct?"</svg>":"");return[bn(t,l),i]};class Je{constructor({strings:e,["_$litType$"]:o},i){this.parts=[];let n,s=0,r=0;const l=e.length-1,a=this.parts,[d,c]=qs(e,o);if(this.el=Je.createElement(d,i),be.currentNode=this.el.content,o===Ct){const m=this.el.content,h=m.firstChild;h.remove(),m.append(...h.childNodes)}for(;(n=be.nextNode())!==null&&a.length<l;){if(n.nodeType===1){{const m=n.localName;if(/^(?:textarea|template)$/i.test(m)&&n.innerHTML.includes(re)){const h=`Expressions are not supported inside \`${m}\` elements. See https://lit.dev/msg/expression-in-${m} for more information.`;if(m==="template")throw new Error(h);St("",h)}}if(n.hasAttributes()){const m=[];for(const h of n.getAttributeNames())if(h.endsWith(So)||h.startsWith(re)){const y=c[r++];if(m.push(h),y!==void 0){const he=n.getAttribute(y.toLowerCase()+So).split(re),ne=/([.?@])?(.*)/.exec(y);a.push({type:Mo,index:s,name:ne[2],strings:he,ctor:ne[1]==="."?Gs:ne[1]==="?"?Ys:ne[1]==="@"?Js:Vt})}else a.push({type:Vo,index:s})}for(const h of m)n.removeAttribute(h)}if(yn.test(n.tagName)){const m=n.textContent.split(re),h=m.length-1;if(h>0){n.textContent=Me?Me.emptyScript:"";for(let y=0;y<h;y++)n.append(m[y],Ke()),be.nextNode(),a.push({type:kt,index:++s});n.append(m[h],Ke())}}}else if(n.nodeType===8)if(n.data===fn)a.push({type:kt,index:s});else{let h=-1;for(;(h=n.data.indexOf(re,h+1))!==-1;)a.push({type:Hs,index:s}),h+=re.length-1}s++}b==null||b({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,o){const i=xe.createElement("template");return i.innerHTML=e,i}}function Ve(t,e,o=t,i){var n,s,r,l;if(e===Se)return e;let a=i!==void 0?(n=o.__directives)===null||n===void 0?void 0:n[i]:o.__directive;const d=Ye(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==d&&((s=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||s===void 0||s.call(a,!1),d===void 0?a=void 0:(a=new d(t),a._$initialize(t,o,i)),i!==void 0?((r=(l=o).__directives)!==null&&r!==void 0?r:l.__directives=[])[i]=a:o.__directive=a),a!==void 0&&(e=Ve(t,a._$resolve(t,e.values),a,i)),e}class Ws{constructor(e,o){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=o}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var o;const{el:{content:i},parts:n}=this._$template,s=((o=e==null?void 0:e.creationScope)!==null&&o!==void 0?o:xe).importNode(i,!0);be.currentNode=s;let r=be.nextNode(),l=0,a=0,d=n[0];for(;d!==void 0;){if(l===d.index){let c;d.type===kt?c=new ot(r,r.nextSibling,this,e):d.type===Mo?c=new d.ctor(r,d.name,d.strings,this,e):d.type===Vo&&(c=new Xs(r,this,e)),this._$parts.push(c),d=n[++a]}l!==(d==null?void 0:d.index)&&(r=be.nextNode(),l++)}return be.currentNode=xe,s}_update(e){let o=0;for(const i of this._$parts)i!==void 0&&(b==null||b({kind:"set part",part:i,value:e[o],valueIndex:o,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,o),o+=i.strings.length-2):i._$setValue(e[o])),o++}}class ot{constructor(e,o,i,n){var s;this.type=kt,this._$committedValue=$,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=o,this._$parent=i,this.options=n,this.__isConnected=(s=n==null?void 0:n.isConnected)!==null&&s!==void 0?s:!0,this._textSanitizer=void 0}get _$isConnected(){var e,o;return(o=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&o!==void 0?o:this.__isConnected}get parentNode(){let e=q(this._$startNode).parentNode;const o=this._$parent;return o!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=o.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,o=this){var i;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=Ve(this,e,o),Ye(e))e===$||e==null||e===""?(this._$committedValue!==$&&(b==null||b({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=$):e!==this._$committedValue&&e!==Se&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((i=this.options)===null||i===void 0?void 0:i.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else Os(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return q(q(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var o;if(this._$committedValue!==e){if(this._$clear(),Ce!==Mt){const i=(o=this._$startNode.parentNode)===null||o===void 0?void 0:o.nodeName;if(i==="STYLE"||i==="SCRIPT"){let n="Forbidden";throw i==="STYLE"?n="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":n="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(n)}}b==null||b({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==$&&Ye(this._$committedValue)){const o=q(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=xo(o,"data","property")),e=this._textSanitizer(e),b==null||b({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}else{const o=xe.createTextNode("");this._commitNode(o),this._textSanitizer===void 0&&(this._textSanitizer=xo(o,"data","property")),e=this._textSanitizer(e),b==null||b({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}this._$committedValue=e}_commitTemplateResult(e){var o;const{values:i,["_$litType$"]:n}=e,s=typeof n=="number"?this._$getTemplate(e):(n.el===void 0&&(n.el=Je.createElement(bn(n.h,n.h[0]),this.options)),n);if(((o=this._$committedValue)===null||o===void 0?void 0:o._$template)===s)b==null||b({kind:"template updating",template:s,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:i}),this._$committedValue._update(i);else{const r=new Ws(s,this),l=r._clone(this.options);b==null||b({kind:"template instantiated",template:s,instance:r,parts:r._$parts,options:this.options,fragment:l,values:i}),r._update(i),b==null||b({kind:"template instantiated and updated",template:s,instance:r,parts:r._$parts,options:this.options,fragment:l,values:i}),this._commitNode(l),this._$committedValue=r}}_$getTemplate(e){let o=Ci.get(e.strings);return o===void 0&&Ci.set(e.strings,o=new Je(e)),o}_commitIterable(e){gn(this._$committedValue)||(this._$committedValue=[],this._$clear());const o=this._$committedValue;let i=0,n;for(const s of e)i===o.length?o.push(n=new ot(this._insert(Ke()),this._insert(Ke()),this,this.options)):n=o[i],n._$setValue(s),i++;i<o.length&&(this._$clear(n&&q(n._$endNode).nextSibling,i),o.length=i)}_$clear(e=q(this._$startNode).nextSibling,o){var i;for((i=this._$notifyConnectionChanged)===null||i===void 0||i.call(this,!1,!0,o);e&&e!==this._$endNode;){const n=q(e).nextSibling;q(e).remove(),e=n}}setConnected(e){var o;if(this._$parent===void 0)this.__isConnected=e,(o=this._$notifyConnectionChanged)===null||o===void 0||o.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class Vt{constructor(e,o,i,n,s){this.type=Mo,this._$committedValue=$,this._$disconnectableChildren=void 0,this.element=e,this.name=o,this._$parent=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=$,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,o=this,i,n){const s=this.strings;let r=!1;if(s===void 0)e=Ve(this,e,o,0),r=!Ye(e)||e!==this._$committedValue&&e!==Se,r&&(this._$committedValue=e);else{const l=e;e=s[0];let a,d;for(a=0;a<s.length-1;a++)d=Ve(this,l[i+a],o,a),d===Se&&(d=this._$committedValue[a]),r||(r=!Ye(d)||d!==this._$committedValue[a]),d===$?e=$:e!==$&&(e+=(d??"")+s[a+1]),this._$committedValue[a]=d}r&&!n&&this._commitValue(e)}_commitValue(e){e===$?q(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=Ce(this.element,this.name,"attribute")),e=this._sanitizer(e??""),b==null||b({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),q(this.element).setAttribute(this.name,e??""))}}class Gs extends Vt{constructor(){super(...arguments),this.type=js}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=Ce(this.element,this.name,"property")),e=this._sanitizer(e),b==null||b({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===$?void 0:e}}const Ks=Me?Me.emptyScript:"";class Ys extends Vt{constructor(){super(...arguments),this.type=Fs}_commitValue(e){b==null||b({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==$),options:this.options}),e&&e!==$?q(this.element).setAttribute(this.name,Ks):q(this.element).removeAttribute(this.name)}}class Js extends Vt{constructor(e,o,i,n,s){if(super(e,o,i,n,s),this.type=Bs,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${o}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,o=this){var i;if(e=(i=Ve(this,e,o,0))!==null&&i!==void 0?i:$,e===Se)return;const n=this._$committedValue,s=e===$&&n!==$||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==$&&(n===$||s);b==null||b({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:s,addListener:r,oldListener:n}),s&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var o,i;typeof this._$committedValue=="function"?this._$committedValue.call((i=(o=this.options)===null||o===void 0?void 0:o.host)!==null&&i!==void 0?i:this.element,e):this._$committedValue.handleEvent(e)}}class Xs{constructor(e,o,i){this.element=e,this.type=Vo,this._$disconnectableChildren=void 0,this._$parent=o,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){b==null||b({kind:"commit to element binding",element:this.element,value:e,options:this.options}),Ve(this,e)}}const so=F.litHtmlPolyfillSupportDevMode;so==null||so(Je,ot);((eo=F.litHtmlVersions)!==null&&eo!==void 0?eo:F.litHtmlVersions=[]).push("2.8.0");F.litHtmlVersions.length>1&&St("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const we=(t,e,o)=>{var i,n;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const s=As++,r=(i=o==null?void 0:o.renderBefore)!==null&&i!==void 0?i:e;let l=r._$litPart$;if(b==null||b({kind:"begin render",id:s,value:t,container:e,options:o,part:l}),l===void 0){const a=(n=o==null?void 0:o.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=l=new ot(e.insertBefore(Ke(),a),a,void 0,o??{})}return l._$setValue(t),b==null||b({kind:"end render",id:s,value:t,container:e,options:o,part:l}),l};we.setSanitizer=Ns,we.createSanitizer=xo,we._testOnlyClearSanitizerFactoryDoNotCallOrElse=Is;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ro,ao,lo;let Do;{const t=(ro=globalThis.litIssuedWarnings)!==null&&ro!==void 0?ro:globalThis.litIssuedWarnings=new Set;Do=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}class A extends ie{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){var e,o;const i=super.createRenderRoot();return(e=(o=this.renderOptions).renderBefore)!==null&&e!==void 0||(o.renderBefore=i.firstChild),i}update(e){const o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=we(o,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!1)}render(){return Se}}A.finalized=!0;A._$litElement$=!0;(ao=globalThis.litElementHydrateSupport)===null||ao===void 0||ao.call(globalThis,{LitElement:A});const co=globalThis.litElementPolyfillSupportDevMode;co==null||co({LitElement:A});A.finalize=function(){if(!ie.finalize.call(this))return!1;const e=(o,i,n=!1)=>{if(o.hasOwnProperty(i)){const s=(typeof o=="function"?o:o.constructor).name;Do(n?"renamed-api":"removed-api",`\`${i}\` is implemented on class ${s}. It has been ${n?"renamed":"removed"} in this version of LitElement.`)}};return e(this,"render"),e(this,"getStyles",!0),e(this.prototype,"adoptStyles"),!0};((lo=globalThis.litElementVersions)!==null&&lo!==void 0?lo:globalThis.litElementVersions=[]).push("3.3.3");globalThis.litElementVersions.length>1&&Do("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var ho;const ir=window;((ho=ir.HTMLSlotElement)===null||ho===void 0?void 0:ho.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */class ar extends rr{constructor(e){var o;if(super(e),e.type!==nr.ATTRIBUTE||e.name!=="class"||((o=e.strings)===null||o===void 0?void 0:o.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(o=>e[o]).join(" ")+" "}update(e,[o]){var i,n;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in o)o[r]&&!(!((i=this._staticClasses)===null||i===void 0)&&i.has(r))&&this._previousClasses.add(r);return this.render(o)}const s=e.element.classList;this._previousClasses.forEach(r=>{r in o||(s.remove(r),this._previousClasses.delete(r))});for(const r in o){const l=!!o[r];l!==this._previousClasses.has(r)&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(r))&&(l?(s.add(r),this._previousClasses.add(r)):(s.remove(r),this._previousClasses.delete(r)))}return Se}}const zo=sr(ar),uo="css-loading-indicator";var K;(function(t){t.IDLE="",t.FIRST="first",t.SECOND="second",t.THIRD="third"})(K||(K={}));class O extends A{constructor(){super(),this.firstDelay=450,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=K.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=R.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,o;const i=window;return!((e=i.Vaadin)===null||e===void 0)&&e.connectionIndicator||(i.Vaadin=i.Vaadin||{},i.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(i.Vaadin.connectionIndicator)),(o=i.Vaadin)===null||o===void 0?void 0:o.connectionIndicator}render(){return _`
    ...
    `}getLoadingBarStyle(){switch(this.loadingBarState){case K.IDLE:return"display: none";case K.FIRST:case K.SECOND:case K.THIRD:return"display: block";default:return""}}timeoutFor(e,o,i,n){return e!==0&&window.clearTimeout(e),o?window.setTimeout(i,n):0}static get instance(){return O.create()}}B([w({type:Number})],O.prototype,"firstDelay",void 0);B([w({type:Number})],O.prototype,"secondDelay",void 0);B([w({type:Number})],O.prototype,"thirdDelay",void 0);B([w({type:Number})],O.prototype,"expandedDuration",void 0);B([w({type:String})],O.prototype,"onlineText",void 0);B([w({type:String})],O.prototype,"offlineText",void 0);B([w({type:String})],O.prototype,"reconnectingText",void 0);B([w({type:Boolean,reflect:!0})],O.prototype,"offline",void 0);B([w({type:Boolean,reflect:!0})],O.prototype,"reconnecting",void 0);B([w({type:Boolean,reflect:!0})],O.prototype,"expanded",void 0);B([w({type:Boolean,reflect:!0})],O.prototype,"loading",void 0);B([w({type:String})],O.prototype,"loadingBarState",void 0);B([w({type:Boolean})],O.prototype,"applyDefaultTheme",null);customElements.get("vaadin-connection-indicator")===void 0&&customElements.define("vaadin-connection-indicator",O);O.instance;const Xe=window;Xe.Vaadin=Xe.Vaadin||{};Xe.Vaadin.registrations=Xe.Vaadin.registrations||[];Xe.Vaadin.registrations.push({is:"@vaadin/common-frontend",version:"0.0.18"});class ki extends Error{}const He=window.document.body,C=window;class lr{constructor(e){this.response=void 0,this.pathname="",this.isActive=!1,this.baseRegex=/^\//,this.navigation="",He.$=He.$||[],this.config=e||{},C.Vaadin=C.Vaadin||{},C.Vaadin.Flow=C.Vaadin.Flow||{},C.Vaadin.Flow.clients={TypeScript:{isActive:()=>this.isActive}};const o=document.head.querySelector("base");this.baseRegex=new RegExp(`^${(document.baseURI||o&&o.href||"/").replace(/^https?:\/\/[^/]+/i,"")}`),this.appShellTitle=document.title,this.addConnectionIndicator()}get serverSideRoutes(){return[{path:"(.*)",action:this.action}]}loadingStarted(){this.isActive=!0,C.Vaadin.connectionState.loadingStarted()}loadingFinished(){this.isActive=!1,C.Vaadin.connectionState.loadingFinished(),!C.Vaadin.listener&&(C.Vaadin.listener={},document.addEventListener("click",e=>{e.target&&(e.target.hasAttribute("router-link")?this.navigation="link":e.composedPath().some(o=>o.nodeName==="A")&&(this.navigation="client"))},{capture:!0}))}get action(){return async e=>{if(this.pathname=e.pathname,C.Vaadin.connectionState.online)try{await this.flowInit()}catch(o){if(o instanceof ki)return C.Vaadin.connectionState.state=R.CONNECTION_LOST,this.offlineStubAction();throw o}else return this.offlineStubAction();return this.container.onBeforeEnter=(o,i)=>this.flowNavigate(o,i),this.container.onBeforeLeave=(o,i)=>this.flowLeave(o,i),this.container}}async flowLeave(e,o){const{connectionState:i}=C.Vaadin;return this.pathname===e.pathname||!this.isFlowClientLoaded()||i.offline?Promise.resolve({}):new Promise(n=>{this.loadingStarted(),this.container.serverConnected=s=>{n(o&&s?o.prevent():{}),this.loadingFinished()},He.$server.leaveNavigation(this.getFlowRoutePath(e),this.getFlowRouteQuery(e))})}async flowNavigate(e,o){return this.response?new Promise(i=>{this.loadingStarted(),this.container.serverConnected=(n,s)=>{o&&n?i(o.prevent()):o&&o.redirect&&s?i(o.redirect(s.pathname)):(this.container.style.display="",i(this.container)),this.loadingFinished()},this.container.serverPaused=()=>{this.loadingFinished()},He.$server.connectClient(this.getFlowRoutePath(e),this.getFlowRouteQuery(e),this.appShellTitle,history.state,this.navigation),this.navigation="history"}):Promise.resolve(this.container)}getFlowRoutePath(e){return decodeURIComponent(e.pathname).replace(this.baseRegex,"")}getFlowRouteQuery(e){return e.search&&e.search.substring(1)||""}async flowInit(){if(!this.isFlowClientLoaded()){this.loadingStarted(),this.response=await this.flowInitUi();const{pushScript:e,appConfig:o}=this.response;typeof e=="string"&&await this.loadScript(e);const{appId:i}=o;await(await g(()=>import("./FlowBootstrap-feff2646.js"),[],import.meta.url)).init(this.response),typeof this.config.imports=="function"&&(this.injectAppIdScript(i),await this.config.imports());const s=`flow-container-${i.toLowerCase()}`,r=document.querySelector(s);r?this.container=r:(this.container=document.createElement(s),this.container.id=i),He.$[i]=this.container;const l=await g(()=>import("./FlowClient-341d667e.js"),[],import.meta.url);await this.flowInitClient(l),this.loadingFinished()}return this.container&&!this.container.isConnected&&(this.container.style.display="none",document.body.appendChild(this.container)),this.response}async loadScript(e){return new Promise((o,i)=>{const n=document.createElement("script");n.onload=()=>o(),n.onerror=i,n.src=e,document.body.appendChild(n)})}injectAppIdScript(e){const o=e.substring(0,e.lastIndexOf("-")),i=document.createElement("script");i.type="module",i.setAttribute("data-app-id",o),document.body.append(i)}async flowInitClient(e){return e.init(),new Promise(o=>{const i=setInterval(()=>{Object.keys(C.Vaadin.Flow.clients).filter(s=>s!=="TypeScript").reduce((s,r)=>s||C.Vaadin.Flow.clients[r].isActive(),!1)||(clearInterval(i),o())},5)})}async flowInitUi(){const e=C.Vaadin&&C.Vaadin.TypeScript&&C.Vaadin.TypeScript.initial;return e?(C.Vaadin.TypeScript.initial=void 0,Promise.resolve(e)):new Promise((o,i)=>{const s=new XMLHttpRequest,r=`?v-r=init&location=${encodeURIComponent(this.getFlowRoutePath(location))}&query=${encodeURIComponent(this.getFlowRouteQuery(location))}`;s.open("GET",r),s.onerror=()=>i(new ki(`Invalid server response when initializing Flow UI.
        ${s.status}
        ${s.responseText}`)),s.onload=()=>{const l=s.getResponseHeader("content-type");l&&l.indexOf("application/json")!==-1?o(JSON.parse(s.responseText)):s.onerror()},s.send()})}addConnectionIndicator(){O.create(),C.addEventListener("online",()=>{if(!this.isFlowClientLoaded()){C.Vaadin.connectionState.state=R.RECONNECTING;const e=new XMLHttpRequest;e.open("HEAD","sw.js"),e.onload=()=>{C.Vaadin.connectionState.state=R.CONNECTED},e.onerror=()=>{C.Vaadin.connectionState.state=R.CONNECTION_LOST},setTimeout(()=>e.send(),50)}}),C.addEventListener("offline",()=>{this.isFlowClientLoaded()||(C.Vaadin.connectionState.state=R.CONNECTION_LOST)})}async offlineStubAction(){const e=document.createElement("iframe"),o="./offline-stub.html";e.setAttribute("src",o),e.setAttribute("style","width: 100%; height: 100%; border: 0"),this.response=void 0;let i;const n=()=>{i!==void 0&&(C.Vaadin.connectionState.removeStateChangeListener(i),i=void 0)};return e.onBeforeEnter=(s,r,l)=>{i=()=>{C.Vaadin.connectionState.online&&(n(),l.render(s,!1))},C.Vaadin.connectionState.addStateChangeListener(i)},e.onBeforeLeave=(s,r,l)=>{n()},e}isFlowClientLoaded(){return this.response!==void 0}}const{serverSideRoutes:dr}=new lr({imports:()=>g(()=>import("./generated-flow-imports-7aad8507.js"),[],import.meta.url)}),cr=[...dr],hr=new pe(document.querySelector("#outlet"));hr.setRoutes(cr);(function(){if(typeof document>"u"||"adoptedStyleSheets"in document)return;var t="ShadyCSS"in window&&!ShadyCSS.nativeShadow,e=document.implementation.createHTMLDocument(""),o=new WeakMap,i=typeof DOMException=="object"?Error:DOMException,n=Object.defineProperty,s=Array.prototype.forEach,r=/@import.+?;?$/gm;function l(u){var p=u.replace(r,"");return p!==u&&console.warn("@import rules are not allowed here. See https://github.com/WICG/construct-stylesheets/issues/119#issuecomment-588352418"),p.trim()}function a(u){return"isConnected"in u?u.isConnected:document.contains(u)}function d(u){return u.filter(function(p,E){return u.indexOf(p)===E})}function c(u,p){return u.filter(function(E){return p.indexOf(E)===-1})}function m(u){u.parentNode.removeChild(u)}function h(u){return u.shadowRoot||o.get(u)}var y=["addRule","deleteRule","insertRule","removeRule"],ce=CSSStyleSheet,he=ce.prototype;he.replace=function(){return Promise.reject(new i("Can't call replace on non-constructed CSSStyleSheets."))},he.replaceSync=function(){throw new i("Failed to execute 'replaceSync' on 'CSSStyleSheet': Can't call replaceSync on non-constructed CSSStyleSheets.")};function ne(u){return typeof u=="object"?$e.isPrototypeOf(u)||he.isPrototypeOf(u):!1}function zt(u){return typeof u=="object"?he.isPrototypeOf(u):!1}var H=new WeakMap,ee=new WeakMap,ke=new WeakMap,Te=new WeakMap;function Ut(u,p){var E=document.createElement("style");return ke.get(u).set(p,E),ee.get(u).push(p),E}function se(u,p){return ke.get(u).get(p)}function nt(u,p){ke.get(u).delete(p),ee.set(u,ee.get(u).filter(function(E){return E!==p}))}function Go(u,p){requestAnimationFrame(function(){p.textContent=H.get(u).textContent,Te.get(u).forEach(function(E){return p.sheet[E.method].apply(p.sheet,E.args)})})}function st(u){if(!H.has(u))throw new TypeError("Illegal invocation")}function jt(){var u=this,p=document.createElement("style");e.body.appendChild(p),H.set(u,p),ee.set(u,[]),ke.set(u,new WeakMap),Te.set(u,[])}var $e=jt.prototype;$e.replace=function(p){try{return this.replaceSync(p),Promise.resolve(this)}catch(E){return Promise.reject(E)}},$e.replaceSync=function(p){if(st(this),typeof p=="string"){var E=this;H.get(E).textContent=l(p),Te.set(E,[]),ee.get(E).forEach(function(D){D.isConnected()&&Go(E,se(E,D))})}},n($e,"cssRules",{configurable:!0,enumerable:!0,get:function(){return st(this),H.get(this).sheet.cssRules}}),n($e,"media",{configurable:!0,enumerable:!0,get:function(){return st(this),H.get(this).sheet.media}}),y.forEach(function(u){$e[u]=function(){var p=this;st(p);var E=arguments;Te.get(p).push({method:u,args:E}),ee.get(p).forEach(function(U){if(U.isConnected()){var L=se(p,U).sheet;L[u].apply(L,E)}});var D=H.get(p).sheet;return D[u].apply(D,E)}}),n(jt,Symbol.hasInstance,{configurable:!0,value:ne});var Ko={childList:!0,subtree:!0},Yo=new WeakMap;function Ae(u){var p=Yo.get(u);return p||(p=new Qo(u),Yo.set(u,p)),p}function Jo(u){n(u.prototype,"adoptedStyleSheets",{configurable:!0,enumerable:!0,get:function(){return Ae(this).sheets},set:function(p){Ae(this).update(p)}})}function Ft(u,p){for(var E=document.createNodeIterator(u,NodeFilter.SHOW_ELEMENT,function(U){return h(U)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT},null,!1),D=void 0;D=E.nextNode();)p(h(D))}var rt=new WeakMap,Re=new WeakMap,at=new WeakMap;function On(u,p){return p instanceof HTMLStyleElement&&Re.get(u).some(function(E){return se(E,u)})}function Xo(u){var p=rt.get(u);return p instanceof Document?p.body:p}function Bt(u){var p=document.createDocumentFragment(),E=Re.get(u),D=at.get(u),U=Xo(u);D.disconnect(),E.forEach(function(L){p.appendChild(se(L,u)||Ut(L,u))}),U.insertBefore(p,null),D.observe(U,Ko),E.forEach(function(L){Go(L,se(L,u))})}function Qo(u){var p=this;p.sheets=[],rt.set(p,u),Re.set(p,[]),at.set(p,new MutationObserver(function(E,D){if(!document){D.disconnect();return}E.forEach(function(U){t||s.call(U.addedNodes,function(L){L instanceof Element&&Ft(L,function(Ne){Ae(Ne).connect()})}),s.call(U.removedNodes,function(L){L instanceof Element&&(On(p,L)&&Bt(p),t||Ft(L,function(Ne){Ae(Ne).disconnect()}))})})}))}if(Qo.prototype={isConnected:function(){var u=rt.get(this);return u instanceof Document?u.readyState!=="loading":a(u.host)},connect:function(){var u=Xo(this);at.get(this).observe(u,Ko),Re.get(this).length>0&&Bt(this),Ft(u,function(p){Ae(p).connect()})},disconnect:function(){at.get(this).disconnect()},update:function(u){var p=this,E=rt.get(p)===document?"Document":"ShadowRoot";if(!Array.isArray(u))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+E+": Iterator getter is not callable.");if(!u.every(ne))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+E+": Failed to convert value to 'CSSStyleSheet'");if(u.some(zt))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+E+": Can't adopt non-constructed stylesheets");p.sheets=u;var D=Re.get(p),U=d(u),L=c(D,U);L.forEach(function(Ne){m(se(Ne,p)),nt(Ne,p)}),Re.set(p,U),p.isConnected()&&U.length>0&&Bt(p)}},window.CSSStyleSheet=jt,Jo(Document),"ShadowRoot"in window){Jo(ShadowRoot);var Zo=Element.prototype,Ln=Zo.attachShadow;Zo.attachShadow=function(p){var E=Ln.call(this,p);return p.mode==="closed"&&o.set(this,E),E}}var lt=Ae(document);lt.isConnected()?lt.connect():document.addEventListener("DOMContentLoaded",lt.connect.bind(lt))})();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wn=Symbol.for(""),ur=t=>{if((t==null?void 0:t.r)===wn)return t==null?void 0:t._$litStatic$},pr=t=>{if(t._$litStatic$!==void 0)return t._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)},ht=(t,...e)=>({_$litStatic$:e.reduce((o,i,n)=>o+pr(i)+t[n+1],t[0]),r:wn}),Ti=new Map,mr=t=>(e,...o)=>{const i=o.length;let n,s;const r=[],l=[];let a=0,d=!1,c;for(;a<i;){for(c=e[a];a<i&&(s=o[a],(n=ur(s))!==void 0);)c+=n+e[++a],d=!0;a!==i&&l.push(s),r.push(c),a++}if(a===i&&r.push(e[i]),d){const m=r.join("$$lit$$");e=Ti.get(m),e===void 0&&(r.raw=r,Ti.set(m,e=r)),o=l}return t(e,...o)},vr=mr(_),fr="modulepreload",gr=function(t){return"/"+t},$i={},f=function(t,e,o){if(!e||e.length===0)return t();const i=document.getElementsByTagName("link");return Promise.all(e.map(n=>{if(n=gr(n),n in $i)return;$i[n]=!0;const s=n.endsWith(".css"),r=s?'[rel="stylesheet"]':"";if(o)for(let a=i.length-1;a>=0;a--){const d=i[a];if(d.href===n&&(!s||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${r}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":fr,s||(l.as="script",l.crossOrigin=""),l.href=n,document.head.appendChild(l),s)return new Promise((a,d)=>{l.addEventListener("load",a),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${n}`)))})})).then(()=>t()).catch(n=>{const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n})};function v(t,e,o,i){var n=arguments.length,s=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,o):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(t,e,o,i);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(s=(n<3?r(s):n>3?r(e,o,s):r(e,o))||s);return n>3&&s&&Object.defineProperty(e,o,s),s}function yr(t){var e;const o=[];for(;t&&t.parentNode;){const i=Co(t);if(i.nodeId!==-1){if((e=i.element)!=null&&e.tagName.startsWith("FLOW-CONTAINER-"))break;o.push(i)}t=t.parentElement?t.parentElement:t.parentNode.host}return o.reverse()}function Co(t){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const n of i){const s=o[n];if(s.getNodeId){const r=s.getNodeId(t);if(r>=0)return{nodeId:r,uiId:s.getUIId(),element:t}}}}return{nodeId:-1,uiId:-1,element:void 0}}function _r(t,e){if(t.contains(e))return!0;let o=e;const i=e.ownerDocument;for(;o&&o!==i&&o!==t;)o=o.parentNode||(o instanceof ShadowRoot?o.host:null);return o===t}const br=(t,e)=>{const o=t[e];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((i,n)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(n.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var N;(function(t){t.text="text",t.checkbox="checkbox",t.range="range",t.color="color"})(N||(N={}));const Z={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},wr=Object.freeze(Object.defineProperty({__proto__:null,presets:Z},Symbol.toStringTag,{value:"Module"})),ae={textColor:{propertyName:"color",displayName:"Text color",editorType:N.color,presets:Z.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:N.range,presets:Z.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:N.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:N.checkbox,checkedValue:"italic"}},X={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:N.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:N.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:N.range,presets:Z.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:N.range,presets:Z.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:N.range,presets:Z.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:N.range,presets:Z.lumoSpace,icon:"square"}},Er={height:{propertyName:"height",displayName:"Size",editorType:N.range,presets:Z.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:N.range,presets:Z.lumoSpace,icon:"square"}},ko={iconColor:{propertyName:"color",displayName:"Icon color",editorType:N.color,presets:Z.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:N.range,presets:Z.lumoFontSize,icon:"font"}},xr=[X.backgroundColor,X.borderColor,X.borderWidth,X.borderRadius,X.padding],Sr=[ae.textColor,ae.fontSize,ae.fontWeight,ae.fontStyle],Cr=[ko.iconColor,ko.iconSize],kr=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:Er,iconProperties:ko,shapeProperties:X,standardIconProperties:Cr,standardShapeProperties:xr,standardTextProperties:Sr,textProperties:ae},Symbol.toStringTag,{value:"Module"}));function En(t){const e=t.charAt(0).toUpperCase()+t.slice(1);return{tagName:t,displayName:e,elements:[{selector:t,displayName:"Element",properties:[X.backgroundColor,X.borderColor,X.borderWidth,X.borderRadius,X.padding,ae.textColor,ae.fontSize,ae.fontWeight,ae.fontStyle]}]}}const Tr=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:En},Symbol.toStringTag,{value:"Module"})),$r=t=>br(Object.assign({"./components/defaults.ts":()=>f(()=>Promise.resolve().then(()=>kr),void 0),"./components/generic.ts":()=>f(()=>Promise.resolve().then(()=>Tr),void 0),"./components/presets.ts":()=>f(()=>Promise.resolve().then(()=>wr),void 0),"./components/vaadin-accordion-heading.ts":()=>f(()=>g(()=>import("./vaadin-accordion-heading-c0acdd6d-4577cebf.js"),[],import.meta.url),[]),"./components/vaadin-accordion-panel.ts":()=>f(()=>g(()=>import("./vaadin-accordion-panel-616e55d6-aa3971e1.js"),[],import.meta.url),[]),"./components/vaadin-accordion.ts":()=>f(()=>g(()=>import("./vaadin-accordion-eed3b794-74106c05.js"),[],import.meta.url),[]),"./components/vaadin-app-layout.ts":()=>f(()=>g(()=>import("./vaadin-app-layout-e56de2e9-732db4d5.js"),[],import.meta.url),[]),"./components/vaadin-avatar.ts":()=>f(()=>g(()=>import("./vaadin-avatar-7599297d-330e40c8.js"),[],import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>f(()=>g(()=>import("./vaadin-big-decimal-field-e51def24-432c04c4.js"),["./vaadin-big-decimal-field-e51def24-432c04c4.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-big-decimal-field-e51def24.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-board-row.ts":()=>f(()=>g(()=>import("./vaadin-board-row-c70d0c55-f861800c.js"),[],import.meta.url),[]),"./components/vaadin-board.ts":()=>f(()=>g(()=>import("./vaadin-board-828ebdea-619d8de9.js"),[],import.meta.url),[]),"./components/vaadin-button.ts":()=>f(()=>g(()=>import("./vaadin-button-2511ad84-44e75a3b.js"),[],import.meta.url),[]),"./components/vaadin-chart.ts":()=>f(()=>g(()=>import("./vaadin-chart-5192dc15-f7f3549f.js"),[],import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>f(()=>g(()=>import("./vaadin-checkbox-group-a7c65bf2-402714eb.js"),["./vaadin-checkbox-group-a7c65bf2-402714eb.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-checkbox-4e68df64-294f6a40.js"],import.meta.url),["assets/vaadin-checkbox-group-a7c65bf2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-checkbox.ts":()=>f(()=>g(()=>import("./vaadin-checkbox-4e68df64-294f6a40.js"),[],import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>f(()=>g(()=>import("./vaadin-combo-box-96451ddd-6f621006.js"),["./vaadin-combo-box-96451ddd-6f621006.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-combo-box-96451ddd.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-confirm-dialog.ts":()=>f(()=>g(()=>import("./vaadin-confirm-dialog-4d718829-64181c27.js"),["./vaadin-confirm-dialog-4d718829-64181c27.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-confirm-dialog-4d718829.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-cookie-consent.ts":()=>f(()=>g(()=>import("./vaadin-cookie-consent-46c09f8b-8bab6e31.js"),[],import.meta.url),[]),"./components/vaadin-crud.ts":()=>f(()=>g(()=>import("./vaadin-crud-8d161a22-90cdc667.js"),[],import.meta.url),[]),"./components/vaadin-custom-field.ts":()=>f(()=>g(()=>import("./vaadin-custom-field-42c85b9e-a1cc265a.js"),["./vaadin-custom-field-42c85b9e-a1cc265a.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-custom-field-42c85b9e.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-picker.ts":()=>f(()=>g(()=>import("./vaadin-date-picker-f2001167-d5898ec8.js"),["./vaadin-date-picker-f2001167-d5898ec8.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-date-picker-f2001167.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-time-picker.ts":()=>f(()=>g(()=>import("./vaadin-date-time-picker-c8c047a7-eddc0020.js"),["./vaadin-date-time-picker-c8c047a7-eddc0020.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-date-time-picker-c8c047a7.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-details-summary.ts":()=>f(()=>g(()=>import("./vaadin-details-summary-351a1448-a6052e04.js"),[],import.meta.url),[]),"./components/vaadin-details.ts":()=>f(()=>g(()=>import("./vaadin-details-bf336660-1ad01c0d.js"),[],import.meta.url),[]),"./components/vaadin-dialog.ts":()=>f(()=>g(()=>import("./vaadin-dialog-53253a08-bc69494f.js"),[],import.meta.url),[]),"./components/vaadin-email-field.ts":()=>f(()=>g(()=>import("./vaadin-email-field-d7a35f04-35d123c2.js"),["./vaadin-email-field-d7a35f04-35d123c2.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-email-field-d7a35f04.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-form-layout.ts":()=>f(()=>g(()=>import("./vaadin-form-layout-47744b1d-89b41005.js"),[],import.meta.url),[]),"./components/vaadin-grid-pro.ts":()=>f(()=>g(()=>import("./vaadin-grid-pro-ff415555-1ef3264a.js"),["./vaadin-grid-pro-ff415555-1ef3264a.js","./vaadin-checkbox-4e68df64-294f6a40.js","./vaadin-grid-0a4791c2-2f2f31a8.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-grid-pro-ff415555.js","assets/vaadin-checkbox-4e68df64.js","assets/vaadin-grid-0a4791c2.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-grid.ts":()=>f(()=>g(()=>import("./vaadin-grid-0a4791c2-2f2f31a8.js"),["./vaadin-grid-0a4791c2-2f2f31a8.js","./vaadin-checkbox-4e68df64-294f6a40.js"],import.meta.url),["assets/vaadin-grid-0a4791c2.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-horizontal-layout.ts":()=>f(()=>g(()=>import("./vaadin-horizontal-layout-3193943f-a9cd4872.js"),[],import.meta.url),[]),"./components/vaadin-icon.ts":()=>f(()=>g(()=>import("./vaadin-icon-601f36ed-00b33200.js"),[],import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>f(()=>g(()=>import("./vaadin-integer-field-85078932-ddedc923.js"),["./vaadin-integer-field-85078932-ddedc923.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-integer-field-85078932.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-list-box.ts":()=>f(()=>g(()=>import("./vaadin-list-box-d7a8433b-f14aab76.js"),[],import.meta.url),[]),"./components/vaadin-login-form.ts":()=>f(()=>g(()=>import("./vaadin-login-form-638996c6-be19a133.js"),["./vaadin-login-form-638996c6-be19a133.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-login-form-638996c6.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-login-overlay.ts":()=>f(()=>g(()=>import("./vaadin-login-overlay-f8a5db8a-2e2a52e2.js"),["./vaadin-login-overlay-f8a5db8a-2e2a52e2.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-login-overlay-f8a5db8a.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-map.ts":()=>f(()=>g(()=>import("./vaadin-map-d40a0116-6848590b.js"),[],import.meta.url),[]),"./components/vaadin-menu-bar.ts":()=>f(()=>g(()=>import("./vaadin-menu-bar-3f5ab096-12c425ea.js"),[],import.meta.url),[]),"./components/vaadin-message-input.ts":()=>f(()=>g(()=>import("./vaadin-message-input-996ac37c-209c4c9a.js"),["./vaadin-message-input-996ac37c-209c4c9a.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-message-input-996ac37c.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-message-list.ts":()=>f(()=>g(()=>import("./vaadin-message-list-70a435ba-720eb499.js"),[],import.meta.url),[]),"./components/vaadin-multi-select-combo-box.ts":()=>f(()=>g(()=>import("./vaadin-multi-select-combo-box-a3373557-088b55c3.js"),["./vaadin-multi-select-combo-box-a3373557-088b55c3.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-multi-select-combo-box-a3373557.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-notification.ts":()=>f(()=>g(()=>import("./vaadin-notification-bd6eb776-4db11d0c.js"),[],import.meta.url),[]),"./components/vaadin-number-field.ts":()=>f(()=>g(()=>import("./vaadin-number-field-cb3ee8b2-ca40ebf2.js"),["./vaadin-number-field-cb3ee8b2-ca40ebf2.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-number-field-cb3ee8b2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-password-field.ts":()=>f(()=>g(()=>import("./vaadin-password-field-d289cb18-1ffd2965.js"),["./vaadin-password-field-d289cb18-1ffd2965.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-password-field-d289cb18.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-progress-bar.ts":()=>f(()=>g(()=>import("./vaadin-progress-bar-309ecf1f-33da342d.js"),[],import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>f(()=>g(()=>import("./vaadin-radio-group-88b5afd8-c06f9812.js"),["./vaadin-radio-group-88b5afd8-c06f9812.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-radio-group-88b5afd8.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-rich-text-editor.ts":()=>f(()=>g(()=>import("./vaadin-rich-text-editor-8cd892f2-970a6385.js"),[],import.meta.url),[]),"./components/vaadin-scroller.ts":()=>f(()=>g(()=>import("./vaadin-scroller-35e68818-0fadb8b4.js"),[],import.meta.url),[]),"./components/vaadin-select.ts":()=>f(()=>g(()=>import("./vaadin-select-df6e9947-a9ee0544.js"),["./vaadin-select-df6e9947-a9ee0544.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-select-df6e9947.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-side-nav-item.ts":()=>f(()=>g(()=>import("./vaadin-side-nav-item-34918f92-a52399d0.js"),[],import.meta.url),[]),"./components/vaadin-side-nav.ts":()=>f(()=>g(()=>import("./vaadin-side-nav-ba80d91d-bf8b89e2.js"),[],import.meta.url),[]),"./components/vaadin-split-layout.ts":()=>f(()=>g(()=>import("./vaadin-split-layout-80c92131-0eb6a169.js"),[],import.meta.url),[]),"./components/vaadin-spreadsheet.ts":()=>f(()=>g(()=>import("./vaadin-spreadsheet-59d8c5ef-4b592d0a.js"),[],import.meta.url),[]),"./components/vaadin-tab.ts":()=>f(()=>g(()=>import("./vaadin-tab-aaf32809-f0658168.js"),[],import.meta.url),[]),"./components/vaadin-tabs.ts":()=>f(()=>g(()=>import("./vaadin-tabs-d9a5e24e-940d7c44.js"),[],import.meta.url),[]),"./components/vaadin-tabsheet.ts":()=>f(()=>g(()=>import("./vaadin-tabsheet-dd99ed9a-45360904.js"),[],import.meta.url),[]),"./components/vaadin-text-area.ts":()=>f(()=>g(()=>import("./vaadin-text-area-83627ebc-d0f0f727.js"),["./vaadin-text-area-83627ebc-d0f0f727.js","./vaadin-text-field-0b3db014-9ef55e43.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-text-area-83627ebc.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-text-field.ts":()=>f(()=>g(()=>import("./vaadin-text-field-0b3db014-9ef55e43.js"),[],import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>f(()=>g(()=>import("./vaadin-time-picker-715ec415-1a25104e.js"),["./vaadin-time-picker-715ec415-1a25104e.js","./vaadin-text-field-0b3db014-9ef55e43.js"],import.meta.url),["assets/vaadin-time-picker-715ec415.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-upload.ts":()=>f(()=>g(()=>import("./vaadin-upload-d3c162ed-ff7a751f.js"),["./vaadin-upload-d3c162ed-ff7a751f.js","./vaadin-button-2511ad84-44e75a3b.js"],import.meta.url),["assets/vaadin-upload-d3c162ed.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-vertical-layout.ts":()=>f(()=>g(()=>import("./vaadin-vertical-layout-ad4174c4-2c76019b.js"),[],import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>f(()=>g(()=>import("./vaadin-virtual-list-96896203-010c76be.js"),[],import.meta.url),[])}),`./components/${t}.ts`);class Ar{constructor(e=$r){this.loader=e,this.metadata={}}async getMetadata(e){var o;const i=(o=e.element)==null?void 0:o.localName;if(!i)return null;if(!i.startsWith("vaadin-"))return En(i);let n=this.metadata[i];if(n)return n;try{n=(await this.loader(i)).default,this.metadata[i]=n}catch{console.warn(`Failed to load metadata for component: ${i}`)}return n||null}}const Rr=new Ar,_t={crosshair:Ie`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
`,Ri="__vaadin-theme-editor-measure-element",Ni=/((::before)|(::after))$/,Ii=/::part\(([\w\d_-]+)\)$/;Uo(k`
...
`);async function Pr(t){const e=new ve(t),o=document.createElement(t.tagName);o.classList.add(Ri),document.body.append(o),t.setupElement&&await t.setupElement(o);const i={themeScope:P.local,localClassName:Ri};try{t.elements.forEach(n=>{Pi(o,n,i,!0);let s=ze(n,i);const r=s.match(Ni);s=s.replace(Ni,"");const l=s.match(Ii),a=s.replace(Ii,"");let d=document.querySelector(a);if(d&&l){const h=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(h)}if(!d)return;d.style.transition="none";const c=r?r[1]:null,m=getComputedStyle(d,c);n.properties.forEach(h=>{const y=m.getPropertyValue(h.propertyName)||h.defaultValue||"";e.updatePropertyValue(n.selector,h.propertyName,y)}),Pi(o,n,i,!1)})}finally{try{t.cleanupElement&&await t.cleanupElement(o)}finally{o.remove()}}return e}function Pi(t,e,o,i){if(e.stateAttribute){if(e.stateElementSelector){const n=ze({...e,selector:e.stateElementSelector},o);t=document.querySelector(n)}t&&(i?t.setAttribute(e.stateAttribute,""):t.removeAttribute(e.stateAttribute))}}function Oi(t){return t.trim()}function Or(t){const e=t.element;if(!e)return null;const o=e.querySelector("label");if(o&&o.textContent)return Oi(o.textContent);const i=e.textContent;return i?Oi(i):null}class Lr{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,o){if(!e)return;const i=this._localClassNameMap.get(e);i&&(e.classList.remove(i),e.overlayClass=null),o?(e.classList.add(o),e.overlayClass=o,this._localClassNameMap.set(e,o)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const ye=new Lr;var Y;(function(t){t.response="themeEditorResponse",t.loadComponentMetadata="themeEditorComponentMetadata",t.setLocalClassName="themeEditorLocalClassName",t.setCssRules="themeEditorRules",t.loadRules="themeEditorLoadRules",t.history="themeEditorHistory",t.openCss="themeEditorOpenCss",t.markAsUsed="themeEditorMarkAsUsed"})(Y||(Y={}));var To;(function(t){t.ok="ok",t.error="error"})(To||(To={}));class Mr{constructor(e){this.pendingRequests={},this.requestCounter=0,this.wrappedConnection=e;const o=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=i=>{i.command===Y.response?this.handleResponse(i.data):o.call(this.wrappedConnection,i)}}sendRequest(e,o){const i=(this.requestCounter++).toString(),n=o.uiId??this.getGlobalUiId();return new Promise((s,r)=>{this.wrappedConnection.send(e,{...o,requestId:i,uiId:n}),this.pendingRequests[i]={resolve:s,reject:r}})}handleResponse(e){const o=this.pendingRequests[e.requestId];if(!o){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code===To.ok?o.resolve(e):o.reject(e)}loadComponentMetadata(e){return this.sendRequest(Y.loadComponentMetadata,{nodeId:e.nodeId})}setLocalClassName(e,o){return this.sendRequest(Y.setLocalClassName,{nodeId:e.nodeId,className:o})}setCssRules(e){return this.sendRequest(Y.setCssRules,{rules:e})}loadRules(e){return this.sendRequest(Y.loadRules,{selectors:e})}markAsUsed(){return this.sendRequest(Y.markAsUsed,{})}undo(e){return this.sendRequest(Y.history,{undo:e})}redo(e){return this.sendRequest(Y.history,{redo:e})}openCss(e){return this.sendRequest(Y.openCss,{selector:e})}getGlobalUiId(){if(this.globalUiId===void 0){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const n of i){const s=o[n];if(s.getNodeId){this.globalUiId=s.getUIId();break}}}}return this.globalUiId??-1}}const M={index:-1,entries:[]};class Vr{constructor(e){this.api=e}get allowUndo(){return M.index>=0}get allowRedo(){return M.index<M.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,o,i){const n={requestId:e,execute:o,rollback:i};if(M.index++,M.entries=M.entries.slice(0,M.index),M.entries.push(n),o)try{o()}catch(s){console.error("Execute history entry failed",s)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=M.entries[M.index];M.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(o){console.error("Undo failed",o)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;M.index++;const e=M.entries[M.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(o){console.error("Redo failed",o)}return this.allowedActions}static clear(){M.entries=[],M.index=-1}}class Dr extends CustomEvent{constructor(e,o,i){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:o,value:i}})}}class W extends A{constructor(){super(...arguments),this.value=""}static get styles(){return[xn,k`
    ...
    `}updateValueFromTheme(){var e;this.propertyValue=this.theme.getPropertyValue(this.elementMetadata.selector,this.propertyMetadata.propertyName),this.value=((e=this.propertyValue)==null?void 0:e.value)||""}dispatchChange(e){this.dispatchEvent(new Dr(this.elementMetadata,this.propertyMetadata,e))}}v([w({})],W.prototype,"elementMetadata",void 0);v([w({})],W.prototype,"propertyMetadata",void 0);v([w({})],W.prototype,"theme",void 0);v([I()],W.prototype,"propertyValue",void 0);v([I()],W.prototype,"value",void 0);class Tt{get values(){return this._values}get rawValues(){return this._rawValues}constructor(e){if(this._values=[],this._rawValues={},e){const o=e.propertyName,i=e.presets??[];this._values=(i||[]).map(s=>s.startsWith("--")?`var(${s})`:s);const n=document.createElement("div");n.style.borderStyle="solid",n.style.visibility="hidden",document.body.append(n);try{this._values.forEach(s=>{n.style.setProperty(o,s);const r=getComputedStyle(n);this._rawValues[s]=r.getPropertyValue(o).trim()})}finally{n.remove()}}}tryMapToRawValue(e){return this._rawValues[e]??e}tryMapToPreset(e){return this.findPreset(e)??e}findPreset(e){const o=e&&e.trim();return this.values.find(i=>this._rawValues[i]===o)}}class Li extends CustomEvent{constructor(e){super("change",{detail:{value:e}})}}let $t=class extends A{constructor(){super(...arguments),this.value="",this.showClearButton=!1}static get styles(){return k`
      :host {
        display: inline-block;
        width: 100%;
        position: relative;
    ...
    `}handleInputChange(t){const e=t.target;this.dispatchEvent(new Li(e.value))}handleClearClick(){this.dispatchEvent(new Li(""))}};v([w({})],$t.prototype,"value",void 0);v([w({})],$t.prototype,"showClearButton",void 0);$t=v([V("vaadin-dev-tools-theme-text-input")],$t);class zr extends CustomEvent{constructor(e){super("class-name-change",{detail:{value:e}})}}let Qe=class extends A{constructor(){super(...arguments),this.editedClassName="",this.invalid=!1}static get styles(){return[xn,k`
        .editor-row {
          padding-top: 0;
        }
    ...
    </div>`}handleInputChange(t){this.editedClassName=t.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new zr(this.editedClassName))}};v([w({})],Qe.prototype,"className",void 0);v([I()],Qe.prototype,"editedClassName",void 0);v([I()],Qe.prototype,"invalid",void 0);Qe=v([V("vaadin-dev-tools-theme-class-name-editor")],Qe);class Ur extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}Uo(k`
...
`);let Ze=class extends A{constructor(){super(...arguments),this.value=P.local}static get styles(){return k`
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",i=`${o}s`;we(_`
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Ur(e))}};v([w({})],Ze.prototype,"value",void 0);v([w({})],Ze.prototype,"metadata",void 0);v([it("vaadin-select")],Ze.prototype,"select",void 0);Ze=v([V("vaadin-dev-tools-theme-scope-selector")],Ze);let Mi=class extends W{static get styles(){return[W.styles,k`
        .editor-row {
          align-items: center;
        }
      `]}handleInputChange(t){const e=t.target.checked?this.propertyMetadata.checkedValue:"";this.dispatchChange(e||"")}renderEditor(){const t=this.value===this.propertyMetadata.checkedValue;return _` <input type="checkbox" .checked=${t} @change=${this.handleInputChange} /> `}};Mi=v([V("vaadin-dev-tools-theme-checkbox-property-editor")],Mi);let Vi=class extends W{handleInputChange(t){this.dispatchChange(t.detail.value)}renderEditor(){var t;return _`
      <vaadin-dev-tools-theme-text-input
        .value=${this.value}
        .showClearButton=${((t=this.propertyValue)==null?void 0:t.modified)||!1}
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};Vi=v([V("vaadin-dev-tools-theme-text-property-editor")],Vi);let At=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new Tt}static get styles(){return[W.styles,k`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
...
`;let et=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[kn,k`
        #toggle {
          display: block;
        }
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");we(_` <div>
        ...
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new la(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};v([w({})],et.prototype,"value",void 0);v([w({})],et.prototype,"presets",void 0);v([it("#toggle")],et.prototype,"toggle",void 0);et=v([V("vaadin-dev-tools-color-picker")],et);let It=class extends A{static get styles(){return[kn,k`
        :host {
          display: block;
          padding: 12px;
        }
      ...
      ></button>`);return _` <div class="swatches">${t}</div>`}handlePickerChange(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t.detail.value}}))}selectPreset(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t,close:!0}}))}};v([w({})],It.prototype,"value",void 0);v([w({})],It.prototype,"presets",void 0);It=v([V("vaadin-dev-tools-color-picker-overlay-content")],It);customElements.whenDefined("vaadin-overlay").then(()=>{const t=customElements.get("vaadin-overlay");class e extends aa(t){}customElements.define("vaadin-dev-tools-color-picker-overlay",e)});customElements.define("vaadin-dev-tools-rgba-string-color-picker",sa);let Bi=class extends W{constructor(){super(...arguments),this.presets=new Tt}static get styles(){return[W.styles,k`
        .editor-row {
          align-items: center;
        }
    ...
    `}handleOpenCss(t){this.dispatchEvent(new da(t))}renderPropertyEditor(t,e){let o;switch(e.editorType){case N.checkbox:o=ht`vaadin-dev-tools-theme-checkbox-property-editor`;break;case N.range:o=ht`vaadin-dev-tools-theme-range-property-editor`;break;case N.color:o=ht`vaadin-dev-tools-theme-color-property-editor`;break;default:o=ht`vaadin-dev-tools-theme-text-property-editor`}return vr` <${o}
        ...
        >
        </${o}>`}};v([w({})],Pt.prototype,"metadata",void 0);v([w({})],Pt.prototype,"theme",void 0);Pt=v([V("vaadin-dev-tools-theme-property-list")],Pt);let Ot=class extends A{render(){return _`<div
      tabindex="-1"
    ...
    `];Ot=v([V("vaadin-dev-tools-shim")],Ot);const Tn=k`
  .popup {
    width: auto;
    position: fixed;
...
`,ca={resolve:t=>de(e=>e.classList.contains("cc-banner"),t)?document.querySelector("vaadin-cookie-consent"):void 0},ha={resolve:t=>{const e=de(o=>o.localName==="vaadin-login-overlay-wrapper",t);return e?e.__dataHost:void 0}},ua={resolve:t=>t.localName==="vaadin-dialog-overlay"?t.__dataHost:void 0},pa={resolve:t=>{const e=de(o=>o.localName==="vaadin-confirm-dialog-overlay",t);return e?e.__dataHost:void 0}},ma={resolve:t=>{const e=de(o=>o.localName==="vaadin-notification-card",t);return e?e.__dataHost:void 0}},va={resolve:t=>t.localName!=="vaadin-menu-bar-item"?void 0:de(e=>e.localName==="vaadin-menu-bar",t)},Hi=[ca,ha,ua,pa,ma,va],fa={resolve:t=>de(e=>e.classList.contains("cc-banner"),t)},ga={resolve:t=>{var e;const o=de(i=>{var n;return((n=i.shadowRoot)==null?void 0:n.querySelector("[part=overlay]"))!=null},t);return(e=o==null?void 0:o.shadowRoot)==null?void 0:e.querySelector("[part=overlay]")}},ya={resolve:t=>{var e;const o=de(i=>i.localName==="vaadin-login-overlay-wrapper",t);return(e=o==null?void 0:o.shadowRoot)==null?void 0:e.querySelector("[part=card]")}},qi=[ya,fa,ga],de=function(t,e){return t(e)?e:e.parentNode&&e.parentNode instanceof HTMLElement?de(t,e.parentNode):void 0};class _a{resolveElement(e){for(const o in Hi){let i=e;if((i=Hi[o].resolve(e))!==void 0)return i}return e}}class ba{resolveElement(e){for(const o in qi){let i=e;if((i=qi[o].resolve(e))!==void 0)return i}return e}}const wa=new _a,Ea=new ba;let fe=class extends A{constructor(){super(),this.active=!1,this.components=[],this.selected=0,this.mouseMoveEvent=this.mouseMoveEvent.bind(this)}connectedCallback(){super.connectedCallback();const t=new CSSStyleSheet;t.replaceSync(`
...
`)+o.textContent.trim()).join("").replace(/^\n/,"");La(e),this._devTools.showNotification(j.INFORMATION,"Environment information copied to clipboard",void 0,void 0,"versionInfoCopied")}};v([w({type:Object})],Lt.prototype,"_devTools",void 0);v([I()],Lt.prototype,"serverInfo",void 0);Lt=v([V("vaadin-dev-tools-info")],Lt);var T,j;(function(t){t.LOG="log",t.INFORMATION="information",t.WARNING="warning",t.ERROR="error"})(j||(j={}));let x=T=class extends A{static get styles(){return[k`
        :host {
...
`?h++:t[h+2]+t[h+3]===`\r
`&&(h+=2)),a="";break}a+=t[h]}c=h+1;continue}d+=l}return d}const za=CSSStyleSheet.toString().includes("document.createElement"),Ua=(t,e)=>{const o=/(?:@media\s(.+?))?(?:\s{)?\@import\s*(?:url\(\s*['"]?(.+?)['"]?\s*\)|(["'])((?:\\.|[^\\])*?)\3)([^;]*);(?:})?/g;/\/\*(.|[\r\n])*?\*\//gm.exec(t)!=null&&(t=Da(t));for(var i,n=t;(i=o.exec(t))!==null;){n=n.replace(i[0],"");const s=document.createElement("link");s.rel="stylesheet",s.href=i[2]||i[4];const r=i[1]||i[5];r&&(s.media=r),e===document?document.head.appendChild(s):e.appendChild(s)}return n},ja=(t,e,o)=>(o?e.adoptedStyleSheets=[t,...e.adoptedStyleSheets]:e.adoptedStyleSheets=[...e.adoptedStyleSheets,t],()=>{e.adoptedStyleSheets=e.adoptedStyleSheets.filter(i=>i!==t)}),Fa=(t,e,o)=>{const i=new CSSStyleSheet;return i.replaceSync(t),za?ja(i,e,o):(o?e.adoptedStyleSheets.splice(0,0,i):e.adoptedStyleSheets.push(i),()=>{e.adoptedStyleSheets.splice(e.adoptedStyleSheets.indexOf(i),1)})},Ba=(t,e)=>{const o=document.createElement("style");o.type="text/css",o.textContent=t;let i;if(e){const s=Array.from(document.head.childNodes).filter(r=>r.nodeType===Node.COMMENT_NODE).find(r=>r.data.trim()===e);s&&(i=s)}return document.head.insertBefore(o,i),()=>{o.remove()}},Ji=(t,e,o,i)=>{if(o===document){const s=Ha(t);if(window.Vaadin.theme.injectedGlobalCss.indexOf(s)!==-1)return;window.Vaadin.theme.injectedGlobalCss.push(s)}const n=Ua(t,o);return o===document?Ba(n,e):Fa(n,o,i)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];function Xi(t){let e,o,i=2166136261;for(e=0,o=t.length;e<o;e++)i^=t.charCodeAt(e),i+=(i<<1)+(i<<4)+(i<<7)+(i<<8)+(i<<24);return("0000000"+(i>>>0).toString(16)).substr(-8)}function Ha(t){let e=Xi(t);return e+Xi(e+t)}document["_vaadintheme_my-theme_componentCss"]||(document["_vaadintheme_my-theme_componentCss"]=!0);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function qa(t){const e=customElements.get(t.is);if(!e)customElements.define(t.is,t);else{const o=e.version;o&&t.version&&o===t.version?console.warn(`The component ${t.is} has been loaded twice`):console.error(`Tried to define ${t.is} version ${t.version} when version ${e.version} is already in use. Something will probably break.`)}}/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Wa extends HTMLElement{static get is(){return"vaadin-lumo-styles"}static get version(){return"24.2.9"}}qa(Wa);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ga=t=>class extends t{static get properties(){return{_theme:{type:String,readOnly:!0}}}static get observedAttributes(){return[...super.observedAttributes,"theme"]}attributeChangedCallback(o,i,n){super.attributeChangedCallback(o,i,n),o==="theme"&&this._set_theme(n)}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Rn=[];function Nn(t){return t&&Object.prototype.hasOwnProperty.call(t,"__themes")}function Ka(t){return Nn(customElements.get(t))}function Ya(t=[]){return[t].flat(1/0).filter(e=>e instanceof Lo?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function In(t,e,o={}){t&&Ka(t)&&console.warn(`The custom element definition for "${t}"
      was finalized before a style module was registered.
      Make sure to add component specific style modules before
      importing the corresponding custom element.`),e=Ya(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(t,e,o):Rn.push({themeFor:t,styles:e,include:o.include,moduleId:o.moduleId})}function No(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Rn}function Ja(t,e){return(t||"").split(" ").some(o=>new RegExp(`^${o.split("*").join(".*")}$`,"u").test(e))}function Xa(t=""){let e=0;return t.startsWith("lumo-")||t.startsWith("material-")?e=1:t.startsWith("vaadin-")&&(e=2),e}function Pn(t){const e=[];return t.include&&[].concat(t.include).forEach(o=>{const i=No().find(n=>n.moduleId===o);i?e.push(...Pn(i),...i.styles):console.warn(`Included moduleId ${o} not found in style registry`)},t.styles),e}function Qa(t,e){const o=document.createElement("style");o.innerHTML=t.map(i=>i.cssText).join(`
`),e.content.appendChild(o)}function Za(t){const e=`${t}-default-theme`,o=No().filter(i=>i.moduleId!==e&&Ja(i.themeFor,t)).map(i=>({...i,styles:[...Pn(i),...i.styles],includePriority:Xa(i.moduleId)})).sort((i,n)=>n.includePriority-i.includePriority);return o.length>0?o:No().filter(i=>i.moduleId===e)}const cl=t=>class extends Ga(t){static finalize(){if(super.finalize(),this.elementStyles)return;const o=this.prototype._template;!o||Nn(this)||Qa(this.getStylesForThis(),o)}static finalizeStyles(o){const i=this.getStylesForThis();return o?[...super.finalizeStyles(o),...i]:i}static getStylesForThis(){const o=Object.getPrototypeOf(this.prototype),i=(o?o.constructor.__themes:[])||[];this.__themes=[...i,...Za(this.is)];const n=this.__themes.flatMap(s=>s.styles);return n.filter((s,r)=>r===n.lastIndexOf(s))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const el=(t,...e)=>{const o=document.createElement("style");o.id=t,o.textContent=e.map(i=>i.toString()).join(`
`).replace(":host","html"),document.head.insertAdjacentElement("afterbegin",o)},Dt=(t,...e)=>{el(`lumo-${t}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const tl=k`
...
`;In("",Wo,{moduleId:"lumo-typography"});Dt("typography-props",ol);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const il=k`
  ${hn(Wo.cssText.replace(/,\s*:host/su,""))}
`;Dt("typography",il,!1);const nl=t=>{const e=[];t!==document&&(e.push(Ji(qo.cssText,"",t,!0)),e.push(Ji(Wo.cssText,"",t,!0)))},sl=nl;sl(document);export{rr as D,Ta as E,X as I,A as L,Z as N,ae as O,nr as P,cl as T,al as X,ll as Z,ko as _,Dt as a,Ga as b,k as c,qa as d,we as e,sr as f,$ as g,_ as h,qo as i,Wo as j,I as k,V as l,Ji as m,Se as n,N as o,w as p,Ca as q,In as r,Ie as s,Rn as t,hn as u,Sr as v,Er as w,ka as x,xr as y,Cr as z};
